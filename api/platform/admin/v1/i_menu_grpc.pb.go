...
const (
	MenuService_ListMenusAll_FullMethodName       = "/platform.admin.v1.MenuService/ListMenusAll"
	MenuService_ListMenusTree_FullMethodName      = "/platform.admin.v1.MenuService/ListMenusTree"
	MenuService_ListMenus_FullMethodName          = "/platform.admin.v1.MenuService/ListMenus"
	MenuService_GetMenu_FullMethodName            = "/platform.admin.v1.MenuService/GetMenu"
	MenuService_CreateMenu_FullMethodName         = "/platform.admin.v1.MenuService/CreateMenu"
	MenuService_UpdateMenu_FullMethodName         = "/platform.admin.v1.MenuService/UpdateMenu"
	MenuService_DeleteMenu_FullMethodName         = "/platform.admin.v1.MenuService/DeleteMenu"
	MenuService_ExistMenuByPath_FullMethodName    = "/platform.admin.v1.MenuService/ExistMenuByPath"
	MenuService_ExistMenuByName_FullMethodName    = "/platform.admin.v1.MenuService/ExistMenuByName"
	MenuService_UpdateMenuByStatus_FullMethodName = "/platform.admin.v1.MenuService/UpdateMenuByStatus"
)
...
type MenuServiceClient interface {
	...
	// 判断菜单路径是否存在
	ExistMenuByPath(ctx context.Context, in *v1.ExistMenuByPathRequest, opts ...grpc.CallOption) (*v1.ExistMenuByPathResponse, error)
	// 判断菜单名是否存在
	ExistMenuByName(ctx context.Context, in *v1.ExistMenuByNameRequest, opts ...grpc.CallOption) (*v1.ExistMenuByNameResponse, error)
	// 更新菜单状态
	UpdateMenuByStatus(ctx context.Context, in *v1.UpdateMenuByStatusRequest, opts ...grpc.CallOption) (*v1.UpdateMenuByStatusResponse, error)
}
...
func (c *menuServiceClient) ExistMenuByPath(ctx context.Context, in *v1.ExistMenuByPathRequest, opts ...grpc.CallOption) (*v1.ExistMenuByPathResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(v1.ExistMenuByPathResponse)
...
func (c *menuServiceClient) ExistMenuByName(ctx context.Context, in *v1.ExistMenuByNameRequest, opts ...grpc.CallOption) (*v1.ExistMenuByNameResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(v1.ExistMenuByNameResponse)
...
func (c *menuServiceClient) UpdateMenuByStatus(ctx context.Context, in *v1.UpdateMenuByStatusRequest, opts ...grpc.CallOption) (*v1.UpdateMenuByStatusResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(v1.UpdateMenuByStatusResponse)
	err := c.cc.Invoke(ctx, MenuService_UpdateMenuByStatus_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMenuServiceServer) ListMenusAll(context.Context, *emptypb.Empty) (*v1.ListMenusResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListMenusAll not implemented")
}
func (UnimplementedMenuServiceServer) ListMenusTree(context.Context, *v1.ListMenusTreeRequest) (*v1.ListMenusTreeResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListMenusTree not implemented")
}
...
func (UnimplementedMenuServiceServer) ExistMenuByPath(context.Context, *v1.ExistMenuByPathRequest) (*v1.ExistMenuByPathResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ExistMenuByPath not implemented")
}
func (UnimplementedMenuServiceServer) ExistMenuByName(context.Context, *v1.ExistMenuByNameRequest) (*v1.ExistMenuByNameResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ExistMenuByName not implemented")
}
func (UnimplementedMenuServiceServer) UpdateMenuByStatus(context.Context, *v1.UpdateMenuByStatusRequest) (*v1.UpdateMenuByStatusResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateMenuByStatus not implemented")
}
...
func _MenuService_ExistMenuByPath_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(v1.ExistMenuByPathRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MenuServiceServer).ExistMenuByPath(ctx, req.(*v1.ExistMenuByPathRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _MenuService_ExistMenuByName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(v1.ExistMenuByNameRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MenuServiceServer).ExistMenuByName(ctx, req.(*v1.ExistMenuByNameRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _MenuService_UpdateMenuByStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(v1.UpdateMenuByStatusRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MenuServiceServer).UpdateMenuByStatus(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MenuService_UpdateMenuByStatus_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MenuServiceServer).UpdateMenuByStatus(ctx, req.(*v1.UpdateMenuByStatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MenuService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "platform.admin.v1.MenuService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateMenuByStatus",
			Handler:    _MenuService_UpdateMenuByStatus_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "platform/admin/v1/i_menu.proto",
}
