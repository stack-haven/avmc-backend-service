...
const (
	PostService_ListPosts_FullMethodName          = "/platform.admin.v1.PostService/ListPosts"
	PostService_GetPost_FullMethodName            = "/platform.admin.v1.PostService/GetPost"
	PostService_CreatePost_FullMethodName         = "/platform.admin.v1.PostService/CreatePost"
	PostService_UpdatePost_FullMethodName         = "/platform.admin.v1.PostService/UpdatePost"
	PostService_DeletePost_FullMethodName         = "/platform.admin.v1.PostService/DeletePost"
	PostService_UpdatePostByStatus_FullMethodName = "/platform.admin.v1.PostService/UpdatePostByStatus"
)
...
type PostServiceClient interface {
	// 获取岗位列表
	ListPosts(ctx context.Context, in *v1.ListPostsRequest, opts ...grpc.CallOption) (*v1.ListPostsResponse, error)
	// 获取岗位数据
	...
	// 更新岗位状态
	UpdatePostByStatus(ctx context.Context, in *v1.UpdatePostByStatusRequest, opts ...grpc.CallOption) (*v1.UpdatePostByStatusResponse, error)
}
...
func (c *postServiceClient) ListPosts(ctx context.Context, in *v1.ListPostsRequest, opts ...grpc.CallOption) (*v1.ListPostsResponse, error) {
...
func (c *postServiceClient) UpdatePostByStatus(ctx context.Context, in *v1.UpdatePostByStatusRequest, opts ...grpc.CallOption) (*v1.UpdatePostByStatusResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(v1.UpdatePostByStatusResponse)
...
func (UnimplementedPostServiceServer) ListPosts(context.Context, *v1.ListPostsRequest) (*v1.ListPostsResponse, error) {
...
func (UnimplementedPostServiceServer) UpdatePostByStatus(context.Context, *v1.UpdatePostByStatusRequest) (*v1.UpdatePostByStatusResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdatePostByStatus not implemented")
}
...
func _PostService_ListPosts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PostServiceServer).ListPosts(ctx, req.(*v1.ListPostsRequest))
	}
...
func _PostService_UpdatePostByStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(v1.UpdatePostByStatusRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PostServiceServer).UpdatePostByStatus(ctx, req.(*v1.UpdatePostByStatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PostService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "platform.admin.v1.PostService",
	...
	Metadata: "platform/admin/v1/i_post.proto",
}
