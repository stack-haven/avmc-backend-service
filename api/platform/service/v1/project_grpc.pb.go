...
const (
	ProjectService_ListProjects_FullMethodName          = "/platform.service.v1.ProjectService/ListProjects"
	ProjectService_GetProject_FullMethodName            = "/platform.service.v1.ProjectService/GetProject"
	ProjectService_CreateProject_FullMethodName         = "/platform.service.v1.ProjectService/CreateProject"
	ProjectService_UpdateProject_FullMethodName         = "/platform.service.v1.ProjectService/UpdateProject"
	ProjectService_DeleteProject_FullMethodName         = "/platform.service.v1.ProjectService/DeleteProject"
	ProjectService_UpdateProjectByStatus_FullMethodName = "/platform.service.v1.ProjectService/UpdateProjectByStatus"
)
...
type ProjectServiceClient interface {
	...
	// 更新项目状态
	UpdateProjectByStatus(ctx context.Context, in *UpdateProjectByStatusRequest, opts ...grpc.CallOption) (*UpdateProjectByStatusResponse, error)
}
...
func (c *projectServiceClient) UpdateProjectByStatus(ctx context.Context, in *UpdateProjectByStatusRequest, opts ...grpc.CallOption) (*UpdateProjectByStatusResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdateProjectByStatusResponse)
...
func (UnimplementedProjectServiceServer) UpdateProjectByStatus(context.Context, *UpdateProjectByStatusRequest) (*UpdateProjectByStatusResponse, error) {
...
func _ProjectService_UpdateProjectByStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateProjectByStatusRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProjectServiceServer).UpdateProjectByStatus(ctx, req.(*UpdateProjectByStatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ProjectService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "platform.service.v1.ProjectService",
	...
	Metadata: "platform/service/v1/project.proto",
}
