...
// Validate checks the field values on UpdateProjectByStatusRequest with the
// rules defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *UpdateProjectByStatusRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on UpdateProjectByStatusRequest with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// UpdateProjectByStatusRequestMultiError, or nil if none found.
func (m *UpdateProjectByStatusRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *UpdateProjectByStatusRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return UpdateProjectByStatusRequestMultiError(errors)
	}

	return nil
}

// UpdateProjectByStatusRequestMultiError is an error wrapping multiple
// validation errors returned by UpdateProjectByStatusRequest.ValidateAll() if
// the designated constraints aren't met.
type UpdateProjectByStatusRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m UpdateProjectByStatusRequestMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m UpdateProjectByStatusRequestMultiError) AllErrors() []error { return m }

// UpdateProjectByStatusRequestValidationError is the validation error returned
// by UpdateProjectByStatusRequest.Validate if the designated constraints
// aren't met.
type UpdateProjectByStatusRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e UpdateProjectByStatusRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e UpdateProjectByStatusRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e UpdateProjectByStatusRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e UpdateProjectByStatusRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e UpdateProjectByStatusRequestValidationError) ErrorName() string {
	return "UpdateProjectByStatusRequestValidationError"
}

// Error satisfies the builtin error interface
func (e UpdateProjectByStatusRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sUpdateProjectByStatusRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = UpdateProjectByStatusRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = UpdateProjectByStatusRequestValidationError{}

// Validate checks the field values on UpdateProjectByStatusResponse with the
// rules defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *UpdateProjectByStatusResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on UpdateProjectByStatusResponse with
// the rules defined in the proto definition for this message. If any rules
// are violated, the result is a list of violation errors wrapped in
// UpdateProjectByStatusResponseMultiError, or nil if none found.
func (m *UpdateProjectByStatusResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *UpdateProjectByStatusResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return UpdateProjectByStatusResponseMultiError(errors)
	}

	return nil
}

// UpdateProjectByStatusResponseMultiError is an error wrapping multiple
// validation errors returned by UpdateProjectByStatusResponse.ValidateAll()
// if the designated constraints aren't met.
type UpdateProjectByStatusResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m UpdateProjectByStatusResponseMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m UpdateProjectByStatusResponseMultiError) AllErrors() []error { return m }

// UpdateProjectByStatusResponseValidationError is the validation error
// returned by UpdateProjectByStatusResponse.Validate if the designated
// constraints aren't met.
type UpdateProjectByStatusResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e UpdateProjectByStatusResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e UpdateProjectByStatusResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e UpdateProjectByStatusResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e UpdateProjectByStatusResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e UpdateProjectByStatusResponseValidationError) ErrorName() string {
	return "UpdateProjectByStatusResponseValidationError"
}

// Error satisfies the builtin error interface
func (e UpdateProjectByStatusResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sUpdateProjectByStatusResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = UpdateProjectByStatusResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = UpdateProjectByStatusResponseValidationError{}
