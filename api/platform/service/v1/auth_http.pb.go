...
const OperationAuthServiceCodes = "/platform.service.v1.AuthService/Codes"
const OperationAuthServiceLoginByEmail = "/platform.service.v1.AuthService/LoginByEmail"
const OperationAuthServiceLoginByPhoneCode = "/platform.service.v1.AuthService/LoginByPhoneCode"
const OperationAuthServiceLoginByUsername = "/platform.service.v1.AuthService/LoginByUsername"
const OperationAuthServiceLoginPassword = "/platform.service.v1.AuthService/LoginPassword"
const OperationAuthServiceLogout = "/platform.service.v1.AuthService/Logout"
const OperationAuthServiceMenus = "/platform.service.v1.AuthService/Menus"
const OperationAuthServiceProfile = "/platform.service.v1.AuthService/Profile"
const OperationAuthServiceRefreshToken = "/platform.service.v1.AuthService/RefreshToken"
const OperationAuthServiceRegister = "/platform.service.v1.AuthService/Register"
const OperationAuthServiceVbenProfile = "/platform.service.v1.AuthService/VbenProfile"
...
func RegisterAuthServiceHTTPServer(s *http.Server, srv AuthServiceHTTPServer) {
	r := s.Route("/")
	r.POST("/platform/v1/auth/register:password", _AuthService_Register0_HTTP_Handler(srv))
	r.POST("/platform/v1/auth/login-password", _AuthService_LoginPassword0_HTTP_Handler(srv))
	r.POST("/platform/v1/auth/login-username", _AuthService_LoginByUsername0_HTTP_Handler(srv))
	r.POST("/platform/v1/auth/login-email", _AuthService_LoginByEmail0_HTTP_Handler(srv))
	r.POST("/platform/v1/auth/login-phoneCode", _AuthService_LoginByPhoneCode0_HTTP_Handler(srv))
	r.POST("/platform/v1/auth/refresh-token", _AuthService_RefreshToken0_HTTP_Handler(srv))
	r.POST("/platform/v1/auth/logout", _AuthService_Logout0_HTTP_Handler(srv))
	r.GET("/platform/v1/auth/profile", _AuthService_Profile0_HTTP_Handler(srv))
	r.GET("/platform/v1/auth/vben-profile", _AuthService_VbenProfile0_HTTP_Handler(srv))
	r.GET("/platform/v1/auth/codes", _AuthService_Codes0_HTTP_Handler(srv))
	r.GET("/platform/v1/auth/menus", _AuthService_Menus0_HTTP_Handler(srv))
}
...
func (c *AuthServiceHTTPClientImpl) Codes(ctx context.Context, in *CodesRequest, opts ...http.CallOption) (*CodesResponse, error) {
	...
	pattern := "/platform/v1/auth/codes"
...
func (c *AuthServiceHTTPClientImpl) LoginByEmail(ctx context.Context, in *LoginByEmailRequest, opts ...http.CallOption) (*LoginResponse, error) {
	...
	pattern := "/platform/v1/auth/login-email"
...
func (c *AuthServiceHTTPClientImpl) LoginByPhoneCode(ctx context.Context, in *LoginByPhoneCodeRequest, opts ...http.CallOption) (*LoginResponse, error) {
	var out LoginResponse
	pattern := "/platform/v1/auth/login-phoneCode"
	path := binding.EncodeURL(pattern, in, false)
...
func (c *AuthServiceHTTPClientImpl) LoginByUsername(ctx context.Context, in *LoginByUsernameRequest, opts ...http.CallOption) (*LoginResponse, error) {
	var out LoginResponse
	pattern := "/platform/v1/auth/login-username"
	path := binding.EncodeURL(pattern, in, false)
...
func (c *AuthServiceHTTPClientImpl) LoginPassword(ctx context.Context, in *LoginPasswordRequest, opts ...http.CallOption) (*LoginResponse, error) {
	var out LoginResponse
	pattern := "/platform/v1/auth/login-password"
	path := binding.EncodeURL(pattern, in, false)
...
func (c *AuthServiceHTTPClientImpl) Logout(ctx context.Context, in *LogoutRequest, opts ...http.CallOption) (*LogoutResponse, error) {
	...
	pattern := "/platform/v1/auth/logout"
	path := binding.EncodeURL(pattern, in, false)
...
func (c *AuthServiceHTTPClientImpl) Menus(ctx context.Context, in *MenusRequest, opts ...http.CallOption) (*MenusResponse, error) {
	...
	pattern := "/platform/v1/auth/menus"
	path := binding.EncodeURL(pattern, in, true)
...
func (c *AuthServiceHTTPClientImpl) Profile(ctx context.Context, in *ProfileRequest, opts ...http.CallOption) (*ProfileResponse, error) {
	...
	pattern := "/platform/v1/auth/profile"
	path := binding.EncodeURL(pattern, in, true)
...
func (c *AuthServiceHTTPClientImpl) RefreshToken(ctx context.Context, in *RefreshTokenRequest, opts ...http.CallOption) (*RefreshTokenResponse, error) {
	...
	pattern := "/platform/v1/auth/refresh-token"
	path := binding.EncodeURL(pattern, in, false)
...
func (c *AuthServiceHTTPClientImpl) Register(ctx context.Context, in *RegisterRequest, opts ...http.CallOption) (*RegisterResponse, error) {
	...
	pattern := "/platform/v1/auth/register:password"
	path := binding.EncodeURL(pattern, in, false)
...
func (c *AuthServiceHTTPClientImpl) VbenProfile(ctx context.Context, in *VbenProfileRequest, opts ...http.CallOption) (*VbenProfileResponse, error) {
	...
	pattern := "/platform/v1/auth/vben-profile"
	path := binding.EncodeURL(pattern, in, true)
