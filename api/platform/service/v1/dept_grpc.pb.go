...
const (
	DeptService_ListDepts_FullMethodName             = "/platform.service.v1.DeptService/ListDepts"
	DeptService_ListDeptsTree_FullMethodName         = "/platform.service.v1.DeptService/ListDeptsTree"
	DeptService_GetDept_FullMethodName               = "/platform.service.v1.DeptService/GetDept"
	DeptService_CreateDept_FullMethodName            = "/platform.service.v1.DeptService/CreateDept"
	DeptService_UpdateDept_FullMethodName            = "/platform.service.v1.DeptService/UpdateDept"
	DeptService_DeleteDept_FullMethodName            = "/platform.service.v1.DeptService/DeleteDept"
	DeptService_GetDeptDeleteImpact_FullMethodName   = "/platform.service.v1.DeptService/GetDeptDeleteImpact"
	DeptService_TransferAndDeleteDept_FullMethodName = "/platform.service.v1.DeptService/TransferAndDeleteDept"
	DeptService_UpdateDeptByStatus_FullMethodName    = "/platform.service.v1.DeptService/UpdateDeptByStatus"
)
...
type DeptServiceClient interface {
	// 获取部门列表
	ListDepts(ctx context.Context, in *ListDeptsRequest, opts ...grpc.CallOption) (*ListDeptsResponse, error)
	// 获取部门树
	ListDeptsTree(ctx context.Context, in *ListDeptsTreeRequest, opts ...grpc.CallOption) (*ListDeptsTreeResponse, error)
	// 获取部门数据
	...
	// 获取删除部门前的影响范围
	GetDeptDeleteImpact(ctx context.Context, in *GetDeptDeleteImpactRequest, opts ...grpc.CallOption) (*GetDeptDeleteImpactResponse, error)
	// 转移部门人员并删除部门
	TransferAndDeleteDept(ctx context.Context, in *TransferAndDeleteDeptRequest, opts ...grpc.CallOption) (*TransferAndDeleteDeptResponse, error)
	// 更新部门状态
	UpdateDeptByStatus(ctx context.Context, in *UpdateDeptByStatusRequest, opts ...grpc.CallOption) (*UpdateDeptByStatusResponse, error)
}
...
func (c *deptServiceClient) ListDepts(ctx context.Context, in *ListDeptsRequest, opts ...grpc.CallOption) (*ListDeptsResponse, error) {
...
func (c *deptServiceClient) ListDeptsTree(ctx context.Context, in *ListDeptsTreeRequest, opts ...grpc.CallOption) (*ListDeptsTreeResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListDeptsTreeResponse)
...
func (c *deptServiceClient) GetDeptDeleteImpact(ctx context.Context, in *GetDeptDeleteImpactRequest, opts ...grpc.CallOption) (*GetDeptDeleteImpactResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetDeptDeleteImpactResponse)
...
func (c *deptServiceClient) TransferAndDeleteDept(ctx context.Context, in *TransferAndDeleteDeptRequest, opts ...grpc.CallOption) (*TransferAndDeleteDeptResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TransferAndDeleteDeptResponse)
...
func (c *deptServiceClient) UpdateDeptByStatus(ctx context.Context, in *UpdateDeptByStatusRequest, opts ...grpc.CallOption) (*UpdateDeptByStatusResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdateDeptByStatusResponse)
...
func (UnimplementedDeptServiceServer) ListDepts(context.Context, *ListDeptsRequest) (*ListDeptsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListDepts not implemented")
}
func (UnimplementedDeptServiceServer) ListDeptsTree(context.Context, *ListDeptsTreeRequest) (*ListDeptsTreeResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListDeptsTree not implemented")
}
...
func (UnimplementedDeptServiceServer) GetDeptDeleteImpact(context.Context, *GetDeptDeleteImpactRequest) (*GetDeptDeleteImpactResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetDeptDeleteImpact not implemented")
}
func (UnimplementedDeptServiceServer) TransferAndDeleteDept(context.Context, *TransferAndDeleteDeptRequest) (*TransferAndDeleteDeptResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method TransferAndDeleteDept not implemented")
}
func (UnimplementedDeptServiceServer) UpdateDeptByStatus(context.Context, *UpdateDeptByStatusRequest) (*UpdateDeptByStatusResponse, error) {
...
func _DeptService_ListDepts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DeptServiceServer).ListDepts(ctx, req.(*ListDeptsRequest))
	}
...
func _DeptService_ListDeptsTree_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DeptServiceServer).ListDeptsTree(ctx, req.(*ListDeptsTreeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _DeptService_GetDeptDeleteImpact_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetDeptDeleteImpactRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DeptServiceServer).GetDeptDeleteImpact(ctx, req.(*GetDeptDeleteImpactRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _DeptService_TransferAndDeleteDept_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TransferAndDeleteDeptRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DeptServiceServer).TransferAndDeleteDept(ctx, req.(*TransferAndDeleteDeptRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _DeptService_UpdateDeptByStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateDeptByStatusRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DeptServiceServer).UpdateDeptByStatus(ctx, req.(*UpdateDeptByStatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DeptService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "platform.service.v1.DeptService",
	...
	Metadata: "platform/service/v1/dept.proto",
}
