...
const (
	MenuService_ListMenusAll_FullMethodName       = "/platform.service.v1.MenuService/ListMenusAll"
	MenuService_ListMenusTree_FullMethodName      = "/platform.service.v1.MenuService/ListMenusTree"
	MenuService_ListMenus_FullMethodName          = "/platform.service.v1.MenuService/ListMenus"
	MenuService_GetMenu_FullMethodName            = "/platform.service.v1.MenuService/GetMenu"
	MenuService_CreateMenu_FullMethodName         = "/platform.service.v1.MenuService/CreateMenu"
	MenuService_UpdateMenu_FullMethodName         = "/platform.service.v1.MenuService/UpdateMenu"
	MenuService_DeleteMenu_FullMethodName         = "/platform.service.v1.MenuService/DeleteMenu"
	MenuService_ExistMenuByPath_FullMethodName    = "/platform.service.v1.MenuService/ExistMenuByPath"
	MenuService_ExistMenuByName_FullMethodName    = "/platform.service.v1.MenuService/ExistMenuByName"
	MenuService_UpdateMenuByStatus_FullMethodName = "/platform.service.v1.MenuService/UpdateMenuByStatus"
)
...
type MenuServiceClient interface {
	// 获取所有菜单
	ListMenusAll(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ListMenusResponse, error)
	// 获取菜单树
	ListMenusTree(ctx context.Context, in *ListMenusTreeRequest, opts ...grpc.CallOption) (*ListMenusTreeResponse, error)
	// 获取菜单列表
	...
	// 更新菜单状态
	UpdateMenuByStatus(ctx context.Context, in *UpdateMenuByStatusRequest, opts ...grpc.CallOption) (*UpdateMenuByStatusResponse, error)
}
...
func (c *menuServiceClient) ListMenusAll(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ListMenusResponse, error) {
...
func (c *menuServiceClient) ListMenusTree(ctx context.Context, in *ListMenusTreeRequest, opts ...grpc.CallOption) (*ListMenusTreeResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListMenusTreeResponse)
...
func (c *menuServiceClient) UpdateMenuByStatus(ctx context.Context, in *UpdateMenuByStatusRequest, opts ...grpc.CallOption) (*UpdateMenuByStatusResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdateMenuByStatusResponse)
...
func (UnimplementedMenuServiceServer) ListMenusAll(context.Context, *emptypb.Empty) (*ListMenusResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListMenusAll not implemented")
}
func (UnimplementedMenuServiceServer) ListMenusTree(context.Context, *ListMenusTreeRequest) (*ListMenusTreeResponse, error) {
...
func (UnimplementedMenuServiceServer) UpdateMenuByStatus(context.Context, *UpdateMenuByStatusRequest) (*UpdateMenuByStatusResponse, error) {
...
func _MenuService_ListMenusTree_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MenuServiceServer).ListMenusTree(ctx, req.(*ListMenusTreeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _MenuService_UpdateMenuByStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateMenuByStatusRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MenuServiceServer).UpdateMenuByStatus(ctx, req.(*UpdateMenuByStatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MenuService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "platform.service.v1.MenuService",
	...
	Metadata: "platform/service/v1/menu.proto",
}
