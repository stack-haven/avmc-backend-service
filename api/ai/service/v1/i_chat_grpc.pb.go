...
func (UnimplementedChatServiceServer) ListChatsSimple(context.Context, *ListChatsRequest) (*ListChatsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListChatsSimple not implemented")
}
...
func (UnimplementedChatServiceServer) StreamChat(context.Context, *StreamChatRequest) (*StreamChatResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method StreamChat not implemented")
}
