...
const file_common_conf_base_proto_rawDesc = "" +
	"\n" +
	"\x16common/conf/base.proto\x12\x04conf\"\xa2\x01\n" +
	"\x04Base\x12&\n" +
	"\x05admin\x18\x01 \x01(\v2\x10.conf.Base.AdminR\x05admin\x12)\n" +
	"\x06domain\x18\x02 \x01(\v2\x11.conf.Base.DomainR\x06domain\x1a=\n" +
	"\x05Admin\x12\x1b\n" +
	"\tdomain_id\x18\x01 \x01(\x04R\bdomainId\x12\x17\n" +
	"\auser_id\x18\x02 \x01(\x04R\x06userId\x1a\b\n" +
	"\x06DomainBk\n" +
	"\bcom.confB\tBaseProtoP\x01Z$backend-service/api/common/conf;conf\xa2\x02\x03CXX\xaa\x02\x04Conf\xca\x02\x04Conf\xe2\x02\x10Conf\\GPBMetadata\xea\x02\x04Confb\x06proto3"
