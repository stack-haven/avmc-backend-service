...
const file_common_conf_registry_proto_rawDesc = "" +
	"\n" +
	"\x1acommon/conf/registry.proto\x12\x04conf\x1a\x1egoogle/protobuf/duration.proto\"\xaa\f\n" +
	"\bRegistry\x12\x12\n" +
	"\x04type\x18\x01 \x01(\tR\x04type\x12-\n" +
	"\x06consul\x18\x02 \x01(\v2\x15.conf.Registry.ConsulR\x06consul\x12'\n" +
	"\x04etcd\x18\x03 \x01(\v2\x13.conf.Registry.EtcdR\x04etcd\x126\n" +
	"\tzookeeper\x18\x04 \x01(\v2\x18.conf.Registry.ZooKeeperR\tzookeeper\x12*\n" +
	"\x05nacos\x18\x05 \x01(\v2\x14.conf.Registry.NacosR\x05nacos\x129\n" +
	"\n" +
	"kubernetes\x18\x06 \x01(\v2\x19.conf.Registry.KubernetesR\n" +
	"kubernetes\x12-\n" +
	"\x06eureka\x18\a \x01(\v2\x15.conf.Registry.EurekaR\x06eureka\x120\n" +
	"\apolaris\x18\b \x01(\v2\x16.conf.Registry.PolarisR\apolaris\x12<\n" +
	"\vservicecomb\x18\t \x01(\v2\x1a.conf.Registry.ServicecombR\vservicecomb\x1a]\n" +
	"\x06Consul\x12\x16\n" +
	...
	"\x17update_cache_when_empty\x18\v \x01(\bR\x14updateCacheWhenEmpty\x1a*\n" +
	"\n" +
	"Kubernetes\x12\x1c\n" +
	"\tnamespace\x18\x01 \x01(\tR\tnamespace\x1a\xca\x01\n" +
	"\x06Eureka\x12\x1c\n" +
	...
	"\tendpoints\x18\x01 \x03(\tR\tendpointsBo\n" +
	"\bcom.confB\rRegistryProtoP\x01Z$backend-service/api/common/conf;conf\xa2\x02\x03CXX\xaa\x02\x04Conf\xca\x02\x04Conf\xe2\x02\x10Conf\\GPBMetadata\xea\x02\x04Confb\x06proto3"
