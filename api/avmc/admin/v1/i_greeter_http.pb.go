...
const OperationGreeterServiceSayHello = "/avmc.admin.v1.GreeterService/SayHello"
...
func RegisterGreeterServiceHTTPServer(s *http.Server, srv GreeterServiceHTTPServer) {
	r := s.Route("/")
	r.GET("/avmc/v1/greeter/hello", _GreeterService_SayHello0_HTTP_Handler(srv))
}
