...
const (
	GreeterService_SayHello_FullMethodName = "/avmc.admin.v1.GreeterService/SayHello"
)
...
var GreeterService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "avmc.admin.v1.GreeterService",
	...
	Metadata: "avmc/admin/v1/i_greeter.proto",
}
