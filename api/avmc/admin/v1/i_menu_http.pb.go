...
func RegisterMenuServiceHTTPServer(s *http.Server, srv MenuServiceHTTPServer) {
	r := s.Route("/")
	r.GET("/avmc/v1/menus", _MenuService_ListMenu0_HTTP_Handler(srv))
	r.GET("/avmc/v1/menus/{id}", _MenuService_GetMenu0_HTTP_Handler(srv))
	r.POST("/avmc/v1/menus", _MenuService_CreateMenu0_HTTP_Handler(srv))
	r.PUT("/avmc/v1/menus/{id}", _MenuService_UpdateMenu0_HTTP_Handler(srv))
	r.DELETE("/avmc/v1/menus/{id}", _MenuService_DeleteMenu0_HTTP_Handler(srv))
}
