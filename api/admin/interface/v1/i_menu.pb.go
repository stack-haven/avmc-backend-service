...
var file_admin_interface_v1_i_menu_proto_rawDesc = string([]byte{
	...
	0x6e, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2f, 0x76, 0x31, 0x2f, 0x6d, 0x65, 0x6e,
	0x75, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xe0, 0x05, 0x0a, 0x0b, 0x4d, 0x65, 0x6e, 0x75,
	...
	0x69, 0x6e, 0x2f, 0x76, 0x31, 0x2f, 0x6d, 0x65, 0x6e, 0x75, 0x73, 0x12, 0x80, 0x01, 0x0a, 0x07,
	...
	0x2f, 0x76, 0x31, 0x2f, 0x6d, 0x65, 0x6e, 0x75, 0x73, 0x2f, 0x7b, 0x69, 0x64, 0x7d, 0x12, 0x95,
	0x01, 0x0a, 0x0a, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4d, 0x65, 0x6e, 0x75, 0x12, 0x23, 0x2e,
	...
	0x2f, 0x6d, 0x65, 0x6e, 0x75, 0x73, 0x12, 0x9a, 0x01, 0x0a, 0x0a, 0x55, 0x70, 0x64, 0x61, 0x74,
	0x65, 0x4d, 0x65, 0x6e, 0x75, 0x12, 0x23, 0x2e, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x2e, 0x73, 0x65,
	0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4d,
	0x65, 0x6e, 0x75, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x24, 0x2e, 0x61, 0x64, 0x6d,
	...
	0x00, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x1c, 0x3a, 0x04, 0x6d, 0x65, 0x6e, 0x75, 0x1a, 0x14, 0x2f,
	0x61, 0x64, 0x6d, 0x69, 0x6e, 0x2f, 0x76, 0x31, 0x2f, 0x6d, 0x65, 0x6e, 0x75, 0x73, 0x2f, 0x7b,
	0x69, 0x64, 0x7d, 0x12, 0x94, 0x01, 0x0a, 0x0a, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x4d, 0x65,
	...
	0x65, 0x4d, 0x65, 0x6e, 0x75, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x3b, 0xba,
	...
	0x6d, 0x65, 0x6e, 0x75, 0x73, 0x2f, 0x7b, 0x69, 0x64, 0x7d, 0x42, 0xbb, 0x01, 0x0a, 0x16, 0x63,
	0x6f, 0x6d, 0x2e, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x2e, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x66, 0x61,
	0x63, 0x65, 0x2e, 0x76, 0x31, 0x42, 0x0a, 0x49, 0x4d, 0x65, 0x6e, 0x75, 0x50, 0x72, 0x6f, 0x74,
...
var file_admin_interface_v1_i_menu_proto_goTypes = []any{
	...
	(*v1.GetMenuRequest)(nil),        // 1: admin.service.v1.GetMenuRequest
	(*v1.CreateMenuRequest)(nil),     // 2: admin.service.v1.CreateMenuRequest
	(*v1.UpdateMenuRequest)(nil),     // 3: admin.service.v1.UpdateMenuRequest
	(*v1.DeleteMenuRequest)(nil),     // 4: admin.service.v1.DeleteMenuRequest
	(*v1.ListMenuResponse)(nil),      // 5: admin.service.v1.ListMenuResponse
	(*v1.Menu)(nil),                  // 6: admin.service.v1.Menu
	(*v1.CreateMenuResponse)(nil),    // 7: admin.service.v1.CreateMenuResponse
	(*v1.UpdateMenuResponse)(nil),    // 8: admin.service.v1.UpdateMenuResponse
	(*v1.DeleteMenuResponse)(nil),    // 9: admin.service.v1.DeleteMenuResponse
}
var file_admin_interface_v1_i_menu_proto_depIdxs = []int32{
	...
	1, // 1: admin.interface.v1.MenuService.GetMenu:input_type -> admin.service.v1.GetMenuRequest
	2, // 2: admin.interface.v1.MenuService.CreateMenu:input_type -> admin.service.v1.CreateMenuRequest
	3, // 3: admin.interface.v1.MenuService.UpdateMenu:input_type -> admin.service.v1.UpdateMenuRequest
	4, // 4: admin.interface.v1.MenuService.DeleteMenu:input_type -> admin.service.v1.DeleteMenuRequest
	5, // 5: admin.interface.v1.MenuService.ListMenu:output_type -> admin.service.v1.ListMenuResponse
	6, // 6: admin.interface.v1.MenuService.GetMenu:output_type -> admin.service.v1.Menu
	7, // 7: admin.interface.v1.MenuService.CreateMenu:output_type -> admin.service.v1.CreateMenuResponse
	8, // 8: admin.interface.v1.MenuService.UpdateMenu:output_type -> admin.service.v1.UpdateMenuResponse
	9, // 9: admin.interface.v1.MenuService.DeleteMenu:output_type -> admin.service.v1.DeleteMenuResponse
