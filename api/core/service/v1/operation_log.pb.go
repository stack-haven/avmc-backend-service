...
func (x *OperationLog) Reset() {
	*x = OperationLog{}
	mi := &file_core_service_v1_operation_log_proto_msgTypes[0]
...
func (*OperationLog) Descriptor() ([]byte, []int) {
	return file_core_service_v1_operation_log_proto_rawDescGZIP(), []int{0}
}
...
var File_core_service_v1_operation_log_proto protoreflect.FileDescriptor

const file_core_service_v1_operation_log_proto_rawDesc = "" +
	"\n" +
	"#core/service/v1/operation_log.proto\x12\x0fcore.service.v1\x1a\x1bbuf/validate/validate.proto\"\xb0\a\n" +
	...
	"\f_resource_idB\v\n" +
	"\t_trace_id\"\x8e\x01\n" +
	"\x19ListOperationLogsResponse\x123\n" +
	"\x05items\x18\x01 \x03(\v2\x1d.core.service.v1.OperationLogR\x05items\x12\x14\n" +
...
var (
	file_core_service_v1_operation_log_proto_rawDescOnce sync.Once
	file_core_service_v1_operation_log_proto_rawDescData []byte
)

func file_core_service_v1_operation_log_proto_rawDescGZIP() []byte {
	file_core_service_v1_operation_log_proto_rawDescOnce.Do(func() {
		file_core_service_v1_operation_log_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_core_service_v1_operation_log_proto_rawDesc), len(file_core_service_v1_operation_log_proto_rawDesc)))
	})
...
func file_core_service_v1_operation_log_proto_init() {
	if File_core_service_v1_operation_log_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		...
		MessageInfos:      file_core_service_v1_operation_log_proto_msgTypes,
	}.Build()
	File_core_service_v1_operation_log_proto = out.File
	file_core_service_v1_operation_log_proto_goTypes = nil
	file_core_service_v1_operation_log_proto_depIdxs = nil
}
