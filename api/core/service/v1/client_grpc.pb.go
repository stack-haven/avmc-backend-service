...
const (
	ClientService_CreateClient_FullMethodName = "/core.service.v1.ClientService/CreateClient"
	ClientService_UpdateClient_FullMethodName = "/core.service.v1.ClientService/UpdateClient"
	ClientService_DeleteClient_FullMethodName = "/core.service.v1.ClientService/DeleteClient"
	ClientService_GetClient_FullMethodName    = "/core.service.v1.ClientService/GetClient"
	ClientService_ListClient_FullMethodName   = "/core.service.v1.ClientService/ListClient"
)
...
func (c *clientServiceClient) ListClient(ctx context.Context, in *pagination.PagingRequest, opts ...grpc.CallOption) (*ListClientResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedClientServiceServer) ListClient(context.Context, *pagination.PagingRequest) (*ListClientResponse, error) {
...
func _ClientService_ListClient_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientServiceServer).ListClient(ctx, req.(*pagination.PagingRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ClientService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "core.service.v1.ClientService",
	...
	Metadata: "core/service/v1/client.proto",
}
