...
const file_core_service_v1_role_proto_rawDesc = "" +
	"\n" +
	"\x1acore/service/v1/role.proto\x12\x0fcore.service.v1\x1a\x1bbuf/validate/validate.proto\x1a\x16common/enum/enum.proto\x1a\"common/pagination/pagination.proto\x1a$gnostic/openapi/v3/annotations.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/protobuf/any.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a google/protobuf/field_mask.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x17validate/validate.proto\"\xc5\t\n" +
	"\x04Role\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\rR\x02id\x124\n" +
	"\x04name\x18\x02 \x01(\tB\x1b\xbaG\x0f\x92\x02\f角色名称\xbaH\x06r\x04\x10\x01\x18\x14H\x00R\x04name\x88\x01\x01\x12l\n" +
	"\x06status\x18\x03 \x01(\x0e2\f.enum.StatusBA\xbaG6\x8a\x02\t\t\x00\x00\x00\x00\x00\x00\xf0?\x92\x02'角色状态 0 未知 1 启用 2 禁用\xbaH\x05\x82\x01\x02\x10\x01H\x01R\x06status\x88\x01\x01\x12@\n" +
	...
	"\x04role\x18\x01 \x01(\v2\x15.core.service.v1.RoleR\x04role\"\xa1\x06\n" +
	...
	"\x06status\x18\x05 \x01(\x0e2\f.enum.StatusB5\xbaG*\x92\x02'角色状态 0 未知 1 启用 2 禁用\xbaH\x05\x82\x01\x02\x10\x01H\x02R\x06status\x88\x01\x01\x127\n" +
	...
	"\x05exist\x18\x01 \x01(\bB\x1b\xbaG\x18\x92\x02\x15角色名是否存在R\x05exist\"\xff\x01\n" +
	"\x19UpdateRoleByStatusRequest\x12%\n" +
	"\x02id\x18\x01 \x01(\rB\x15\xbaG\v\x92\x02\b角色ID\xbaH\x04*\x02 \x00R\x02id\x12`\n" +
	"\x06status\x18\x02 \x01(\x0e2\f.enum.StatusB5\xbaG*\x92\x02'角色状态 0 未知 1 启用 2 禁用\xbaH\x05\x82\x01\x02\x10\x01H\x00R\x06status\x88\x01\x01\x12>\n" +
