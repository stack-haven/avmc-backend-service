...
func (_q *ChatMessageQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *ChatMessageQuery) FirstIDX(ctx context.Context) uint32 {
...
func (_q *ChatMessageQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *ChatMessageQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (_q *ChatMessageQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (_q *ChatMessageQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *ChatMessageQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(chatmessage.Table, chatmessage.Columns, sqlgraph.NewFieldSpec(chatmessage.FieldID, field.TypeUint32))
	_spec.From = _q.sql
...
func (_q *ChatMessageQuery) Modify(modifiers ...func(s *sql.Selector)) *ChatMessageSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (_s *ChatMessageSelect) Modify(modifiers ...func(s *sql.Selector)) *ChatMessageSelect {
