...
func wireApp(confServer *conf.Server, confData *conf.Data, logger log.Logger) (*kratos.App, func(), error) {
	...
	tenantPermissionServiceService := service.NewTenantPermissionServiceService(menuPermissionGroupUsecase, logger)
