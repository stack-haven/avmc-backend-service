...
func seed(ctx context.Context, client *gen.Client, authorizer authzEngine.Authorizer) error {
	...
	bt := func(parent, name, title, code string, s int32) {
		menuBtn(ctx, client, mockMenuSpec{Name: name, Title: title, AuthCode: code, Type: 3, Sort: s, Path: "", Component: "", Icon: ""}, menuMap[parent])
	}
	...
	// 租户管理
	bt("TenantList", "TenantListQuery", "查询", v1.OperationTenantServiceListTenants, 10)
	bt("TenantList", "TenantCreate", "新增", v1.OperationTenantServiceCreateTenant, 20)
	bt("TenantList", "TenantEdit", "编辑", v1.OperationTenantServiceUpdateTenant, 30)
	bt("TenantList", "TenantDelete", "删除", v1.OperationTenantServiceDeleteTenant, 40)
	bt("TenantList", "TenantLifecycle", "生命周期", v1.OperationTenantServiceUpdateTenantLifecycle, 50)
	...
	bt("TenantPackage", "TPQuery", "查询", v1.OperationTenantMenuPermissionGroupServiceListTenantMenuPermissionGroups, 10)
	bt("TenantPackage", "TPCreate", "新增", v1.OperationTenantMenuPermissionGroupServiceCreateTenantMenuPermissionGroup, 20)
	bt("TenantPackage", "TPEdit", "编辑", v1.OperationTenantMenuPermissionGroupServiceUpdateTenantMenuPermissionGroup, 30)
	bt("TenantPackage", "TPDelete", "删除", v1.OperationTenantMenuPermissionGroupServiceDeleteTenantMenuPermissionGroup, 40)
	bt("TenantPackage", "TPStatus", "启停", v1.OperationTenantMenuPermissionGroupServiceUpdateTenantMenuPermissionGroupStatus, 50)
	bt("TenantPackage", "TPVersions", "版本列表", v1.OperationTenantMenuPermissionGroupServiceListTenantMenuPermissionGroupVersions, 60)
	bt("TenantPackage", "TPPublish", "发布版本", v1.OperationTenantMenuPermissionGroupServicePublishTenantMenuPermissionGroupVersion, 70)
	bt("TenantPackage", "TPRollback", "回滚版本", v1.OperationTenantMenuPermissionGroupServiceRollbackTenantMenuPermissionGroupVersion, 80)
	// 组织架构
	bt("UserManagement", "UserQuery", "查询", v1.OperationUserServiceListUsers, 10)
	bt("UserManagement", "UserCreate", "新增", v1.OperationUserServiceCreateUser, 20)
	bt("UserManagement", "UserEdit", "编辑", v1.OperationUserServiceUpdateUser, 30)
	bt("UserManagement", "UserDelete", "删除", v1.OperationUserServiceDeleteUser, 40)
	bt("UserManagement", "UserStatus", "启停", v1.OperationUserServiceUpdateUserByStatus, 50)
	bt("UserManagement", "DeptQuery", "部门查询", v1.OperationDeptServiceListDepts, 60)
	bt("UserManagement", "DeptCreate", "部门新增", v1.OperationDeptServiceCreateDept, 70)
	bt("UserManagement", "DeptEdit", "部门编辑", v1.OperationDeptServiceUpdateDept, 80)
	bt("UserManagement", "DeptDelete", "部门删除", v1.OperationDeptServiceDeleteDept, 90)
	bt("UserManagement", "DeptStatus", "部门启停", v1.OperationDeptServiceUpdateDeptByStatus, 100)
	...
	btOperation("UserManagement", "RoleSimpleQuery", "角色简单列表", "/platform.admin.v1.RoleService/ListRoleSimple", 140)
	bt("PostManagement", "PostQuery", "查询", v1.OperationPostServiceListPosts, 10)
	bt("PostManagement", "PostCreate", "新增", v1.OperationPostServiceCreatePost, 20)
	bt("PostManagement", "PostEdit", "编辑", v1.OperationPostServiceUpdatePost, 30)
	bt("PostManagement", "PostDelete", "删除", v1.OperationPostServiceDeletePost, 40)
	bt("PostManagement", "PostStatus", "启停", v1.OperationPostServiceUpdatePostByStatus, 50)
	bt("RoleManagement", "RoleQuery", "查询", v1.OperationRoleServiceListRoles, 10)
	bt("RoleManagement", "RoleCreate", "新增", v1.OperationRoleServiceCreateRole, 20)
	bt("RoleManagement", "RoleEdit", "编辑", v1.OperationRoleServiceUpdateRole, 30)
	bt("RoleManagement", "RoleDelete", "删除", v1.OperationRoleServiceDeleteRole, 40)
	bt("RoleManagement", "RoleStatus", "启停", v1.OperationRoleServiceUpdateRoleByStatus, 50)
	btOperation("RoleManagement", "RoleSimpleQuery", "角色简单列表", "/platform.admin.v1.RoleService/ListRoleSimple", 60)
	bt("ProjectManagement", "ProjectQuery", "查询", v1.OperationProjectServiceListProjects, 10)
	bt("ProjectManagement", "ProjectCreate", "新增", v1.OperationProjectServiceCreateProject, 20)
	bt("ProjectManagement", "ProjectEdit", "编辑", v1.OperationProjectServiceUpdateProject, 30)
	bt("ProjectManagement", "ProjectDelete", "删除", v1.OperationProjectServiceDeleteProject, 40)
	bt("ProjectManagement", "ProjectStatus", "启停", v1.OperationProjectServiceUpdateProjectByStatus, 50)
	// 权限与安全
	bt("MenuManagement", "MenuQuery", "查询", v1.OperationMenuServiceListMenus, 10)
	bt("MenuManagement", "MenuCreate", "新增", v1.OperationMenuServiceCreateMenu, 20)
	bt("MenuManagement", "MenuEdit", "编辑", v1.OperationMenuServiceUpdateMenu, 30)
	bt("MenuManagement", "MenuDelete", "删除", v1.OperationMenuServiceDeleteMenu, 40)
	bt("MenuManagement", "MenuStatus", "启停", v1.OperationMenuServiceUpdateMenuByStatus, 50)
	// 文件中心
	bt("FileList", "FileQuery", "查询", v1.OperationFileCenterServiceListFileObjects, 10)
	bt("FileList", "FileUpload", "上传", v1.OperationFileCenterServiceCreateFileUploadSession, 20)
	bt("FileList", "FileDelete", "删除", v1.OperationFileCenterServiceDeleteFileObject, 30)
	bt("FileList", "FileDownload", "下载", v1.OperationFileCenterServicePresignFileDownload, 40)
	bt("StorageProvider", "StorageQuery", "查询", v1.OperationStorageProviderServiceListStorageProviders, 10)
	bt("StorageProvider", "StorageCreate", "新增", v1.OperationStorageProviderServiceCreateStorageProvider, 20)
	bt("StorageProvider", "StorageEdit", "编辑", v1.OperationStorageProviderServiceUpdateStorageProvider, 30)
	bt("StorageProvider", "StorageDelete", "删除", v1.OperationStorageProviderServiceDeleteStorageProvider, 40)
	bt("StorageProvider", "StorageDefault", "设为默认", v1.OperationStorageProviderServiceSetDefaultStorageProvider, 50)
	// 通知中心
	bt("NotifTemplate", "NTQuery", "查询", v1.OperationNotificationServiceListNotificationTemplates, 10)
	bt("NotifTemplate", "NTCreate", "新增", v1.OperationNotificationServiceCreateNotificationTemplate, 20)
	bt("NotifTemplate", "NTEdit", "编辑", v1.OperationNotificationServiceUpdateNotificationTemplate, 30)
	bt("NotifTemplate", "NTDelete", "删除", v1.OperationNotificationServiceDeleteNotificationTemplate, 40)
	bt("NotifRecord", "NMsgQuery", "查询", v1.OperationNotificationServiceListNotificationMessages, 10)
	bt("NotifRecord", "NMsgSend", "发送", v1.OperationNotificationServiceSendInAppNotification, 20)
	bt("NotifProvider", "NPQuery", "查询", v1.OperationNotificationProviderServiceListNotificationProviders, 10)
	bt("NotifProvider", "NPCreate", "新增", v1.OperationNotificationProviderServiceCreateNotificationProvider, 20)
	bt("NotifProvider", "NPEdit", "编辑", v1.OperationNotificationProviderServiceUpdateNotificationProvider, 30)
	bt("NotifProvider", "NPDelete", "删除", v1.OperationNotificationProviderServiceDeleteNotificationProvider, 40)
	bt("NotifProvider", "NPDefault", "设默认", v1.OperationNotificationProviderServiceSetDefaultNotificationProvider, 50)
	bt("NotifProvider", "NPTest", "测试", v1.OperationNotificationProviderServiceTestNotificationProvider, 60)
	// 系统管理
	bt("Dictionary", "DictQuery", "查询", v1.OperationDictionaryServiceListDictionaryTypes, 10)
	bt("Dictionary", "DictCreate", "新增", v1.OperationDictionaryServiceCreateDictionaryType, 20)
	bt("Dictionary", "DictEdit", "编辑", v1.OperationDictionaryServiceUpdateDictionaryType, 30)
	bt("Dictionary", "DictDelete", "删除", v1.OperationDictionaryServiceDeleteDictionaryType, 40)
	bt("Parameter", "ParamQuery", "查询", v1.OperationParameterServiceListParameterDefinitions, 10)
	bt("Parameter", "ParamCreate", "新增", v1.OperationParameterServiceCreateParameterDefinition, 20)
	bt("Parameter", "ParamEdit", "编辑", v1.OperationParameterServiceUpdateParameterDefinition, 30)
	bt("Parameter", "ParamDelete", "删除", v1.OperationParameterServiceDeleteParameterDefinition, 40)
	bt("OperationLog", "OLQuery", "查询", v1.OperationOperationLogServiceListOperationLogs, 10)
	bt("LoginLog", "LLQuery", "查询", v1.OperationLoginLogServiceListLoginLogs, 10)
	bt("Session", "SessionQuery", "查询", v1.OperationSessionServiceListSessions, 10)
	bt("Session", "SessionRevoke", "踢下线", v1.OperationSessionServiceRevokeSession, 20)
	bt("AsyncTask", "ATQuery", "查询", v1.OperationAsyncTaskServiceListAsyncTasks, 10)
	bt("AsyncTask", "ATCancel", "取消", v1.OperationAsyncTaskServiceCancelAsyncTask, 20)
	bt("AsyncTask", "ATRetry", "重试", v1.OperationAsyncTaskServiceRetryAsyncTask, 30)
	bt("Webhook", "WHQuery", "查询", v1.OperationWebhookServiceListWebhookSubscriptions, 10)
	bt("Webhook", "WHCreate", "新增", v1.OperationWebhookServiceCreateWebhookSubscription, 20)
	bt("Webhook", "WHEdit", "编辑", v1.OperationWebhookServiceUpdateWebhookSubscription, 30)
	bt("Webhook", "WHDelete", "删除", v1.OperationWebhookServiceDeleteWebhookSubscription, 40)
	bt("Webhook", "WHRetry", "重试", v1.OperationWebhookServiceRetryWebhookDelivery, 50)
