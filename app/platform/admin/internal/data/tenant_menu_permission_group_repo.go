...
func (r *tenantMenuPermissionGroupRepo) entToProto(e *gen.TenantMenuPermissionGroup) *pbCore.TenantMenuPermissionGroup {
	if e == nil {
		return nil
	}
	...
	result := &pbCore.TenantMenuPermissionGroup{
		Id:             e.ID,
...
func TenantMenuPermissionGroupVersionToProto(e *gen.TenantMenuPermissionGroupVersion) *pbCore.TenantMenuPermissionGroupVersion {
	if e == nil {
		return nil
	}
	return &pbCore.TenantMenuPermissionGroupVersion{
		Id:             e.ID,
		GroupId:        e.GroupID,
		Version:        e.Version,
		State:          pbCore.TenantMenuPermissionGroupVersionState(e.State),
...
func (r *tenantMenuPermissionGroupRepo) Save(ctx context.Context, g *pbCore.TenantMenuPermissionGroup) (*pbCore.TenantMenuPermissionGroup, error) {
...
func (r *tenantMenuPermissionGroupRepo) Update(ctx context.Context, g *pbCore.TenantMenuPermissionGroup) (*pbCore.TenantMenuPermissionGroup, error) {
	...
	if versionChanged {
		_, publishErr := r.publishVersionTx(ctx, tx, g.GetId(), &pbCore.TenantMenuPermissionGroupVersion{
...
func (r *tenantMenuPermissionGroupRepo) FindByID(ctx context.Context, id uint32) (*pbCore.TenantMenuPermissionGroup, error) {
...
func (r *tenantMenuPermissionGroupRepo) ListTenantMenuPermissionGroups(ctx context.Context, opts ...listing.Option) ([]*pbCore.TenantMenuPermissionGroup, error) {
...
func (r *tenantMenuPermissionGroupRepo) UpdateStatus(ctx context.Context, id uint32, status pbEnum.Status) (*pbCore.TenantMenuPermissionGroup, error) {
...
func (r *tenantMenuPermissionGroupRepo) ListVersions(ctx context.Context, groupID uint32) ([]*pbCore.TenantMenuPermissionGroupVersion, error) {
	if groupID == 0 {
...
func (r *tenantMenuPermissionGroupRepo) PublishVersion(ctx context.Context, groupID uint32, input *pbCore.TenantMenuPermissionGroupVersion, summary string, operatorID uint32, effectiveAt string) (*pbCore.TenantMenuPermissionGroupVersion, error) {
	if input == nil {
		input = &pbCore.TenantMenuPermissionGroupVersion{}
	}
...
func (r *tenantMenuPermissionGroupRepo) RollbackVersion(ctx context.Context, groupID, sourceVersionID uint32, summary string, operatorID uint32) (*pbCore.TenantMenuPermissionGroupVersion, error) {
...
func (r *tenantMenuPermissionGroupRepo) createVersionTx(ctx context.Context, tx *gen.Tx, groupID uint32, version int32, snapshot *pbCore.TenantMenuPermissionGroupVersion, summary string, operatorID uint32) (*gen.TenantMenuPermissionGroupVersion, error) {
	if snapshot == nil {
		snapshot = &pbCore.TenantMenuPermissionGroupVersion{}
	}
	now := time.Now()
	builder := tx.TenantMenuPermissionGroupVersion.Create().
		SetGroupID(groupID).
		SetVersion(version).
		SetState(int32(pbCore.TenantMenuPermissionGroupVersionState_MENU_PERMISSION_GROUP_VERSION_STATE_PUBLISHED)).
...
func (r *tenantMenuPermissionGroupRepo) publishVersionTx(ctx context.Context, tx *gen.Tx, groupID uint32, snapshot *pbCore.TenantMenuPermissionGroupVersion, summary string, operatorID uint32) (*gen.TenantMenuPermissionGroupVersion, error) {
	...
	if _, err = tx.TenantMenuPermissionGroupVersion.Update().
		Where(
			tenantmenupermissiongroupversion.GroupIDEQ(groupID),
			tenantmenupermissiongroupversion.StateEQ(int32(pbCore.TenantMenuPermissionGroupVersionState_MENU_PERMISSION_GROUP_VERSION_STATE_PUBLISHED)),
		).
		SetState(int32(pbCore.TenantMenuPermissionGroupVersionState_MENU_PERMISSION_GROUP_VERSION_STATE_SUPERSEDED)).
		Save(ctx); err != nil {
		return nil, err
	}
...
func groupVersionSnapshotFromGroup(group *pbCore.TenantMenuPermissionGroup) *pbCore.TenantMenuPermissionGroupVersion {
	if group == nil {
		return &pbCore.TenantMenuPermissionGroupVersion{}
	}
	return &pbCore.TenantMenuPermissionGroupVersion{
...
func mergeVersionSnapshot(current *gen.TenantMenuPermissionGroup, input *pbCore.TenantMenuPermissionGroupVersion) *pbCore.TenantMenuPermissionGroupVersion {
	if input == nil {
		input = &pbCore.TenantMenuPermissionGroupVersion{}
	}
	snapshot := &pbCore.TenantMenuPermissionGroupVersion{
...
func (r *tenantMenuPermissionGroupRepo) GetTenantEffectiveMenus(_ context.Context, _ uint32, _ uint32) ([]*pbCore.Menu, error) {
	return nil, nil
}
