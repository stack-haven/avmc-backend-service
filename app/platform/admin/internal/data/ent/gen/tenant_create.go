...
func (_c *TenantCreate) SetStatus(v int32) *TenantCreate {
	_c.mutation.SetStatus(v)
	return _c
}

// SetNillableStatus sets the "status" field if the given value is not nil.
func (_c *TenantCreate) SetNillableStatus(v *int32) *TenantCreate {
	if v != nil {
		_c.SetStatus(*v)
	}
	return _c
...
func (_c *TenantCreate) AddPermissionGroupBindingIDs(ids ...uint32) *TenantCreate {
	_c.mutation.AddPermissionGroupBindingIDs(ids...)
	return _c
}

// AddPermissionGroupBindings adds the "permission_group_bindings" edges to the TenantPermissionGroup entity.
func (_c *TenantCreate) AddPermissionGroupBindings(v ...*TenantPermissionGroup) *TenantCreate {
	ids := make([]uint32, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddPermissionGroupBindingIDs(ids...)
}
...
func (_c *TenantCreate) check() error {
	if _, ok := _c.mutation.Status(); !ok {
		return &ValidationError{Name: "status", err: errors.New(`gen: missing required field "Tenant.status"`)}
	}
...
func (_c *TenantCreate) createSpec() (*Tenant, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.Status(); ok {
		_spec.SetField(tenant.FieldStatus, field.TypeInt32, value)
		_node.Status = &value
	}
	...
	if nodes := _c.mutation.PermissionGroupBindingsIDs(); len(nodes) > 0 {
...
// SetStatus sets the "status" field.
func (u *TenantUpsert) SetStatus(v int32) *TenantUpsert {
...
func (u *TenantUpsert) AddStatus(v int32) *TenantUpsert {
...
// SetStatus sets the "status" field.
func (u *TenantUpsertOne) SetStatus(v int32) *TenantUpsertOne {
...
// AddStatus adds v to the "status" field.
func (u *TenantUpsertOne) AddStatus(v int32) *TenantUpsertOne {
	return u.Update(func(s *TenantUpsert) {
		s.AddStatus(v)
	})
}
...
// SetStatus sets the "status" field.
func (u *TenantUpsertBulk) SetStatus(v int32) *TenantUpsertBulk {
	return u.Update(func(s *TenantUpsert) {
		s.SetStatus(v)
	})
}
...
// AddStatus adds v to the "status" field.
func (u *TenantUpsertBulk) AddStatus(v int32) *TenantUpsertBulk {
	return u.Update(func(s *TenantUpsert) {
		s.AddStatus(v)
	})
}
