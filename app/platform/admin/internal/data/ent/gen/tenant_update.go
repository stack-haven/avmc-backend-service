...
func (_u *TenantUpdate) SetStatus(v int32) *TenantUpdate {
...
func (_u *TenantUpdate) SetNillableStatus(v *int32) *TenantUpdate {
	if v != nil {
		_u.SetStatus(*v)
	}
	return _u
...
func (_u *TenantUpdate) AddStatus(v int32) *TenantUpdate {
...
func (_u *TenantUpdate) AddPermissionGroupBindingIDs(ids ...uint32) *TenantUpdate {
	_u.mutation.AddPermissionGroupBindingIDs(ids...)
	return _u
}

// AddPermissionGroupBindings adds the "permission_group_bindings" edges to the TenantPermissionGroup entity.
func (_u *TenantUpdate) AddPermissionGroupBindings(v ...*TenantPermissionGroup) *TenantUpdate {
	ids := make([]uint32, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.AddPermissionGroupBindingIDs(ids...)
}
...
// ClearPermissionGroupBindings clears all "permission_group_bindings" edges to the TenantPermissionGroup entity.
func (_u *TenantUpdate) ClearPermissionGroupBindings() *TenantUpdate {
	_u.mutation.ClearPermissionGroupBindings()
	return _u
}

// RemovePermissionGroupBindingIDs removes the "permission_group_bindings" edge to TenantPermissionGroup entities by IDs.
func (_u *TenantUpdate) RemovePermissionGroupBindingIDs(ids ...uint32) *TenantUpdate {
	_u.mutation.RemovePermissionGroupBindingIDs(ids...)
	return _u
}

// RemovePermissionGroupBindings removes "permission_group_bindings" edges to TenantPermissionGroup entities.
func (_u *TenantUpdate) RemovePermissionGroupBindings(v ...*TenantPermissionGroup) *TenantUpdate {
	ids := make([]uint32, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.RemovePermissionGroupBindingIDs(ids...)
}
...
func (_u *TenantUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.AddedStatus(); ok {
		_spec.AddField(tenant.FieldStatus, field.TypeInt32, value)
	}
	...
	if _u.mutation.PermissionGroupBindingsCleared() {
	...
	if nodes := _u.mutation.RemovedPermissionGroupBindingsIDs(); len(nodes) > 0 && !_u.mutation.PermissionGroupBindingsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: true,
			Table:   tenant.PermissionGroupBindingsTable,
	...
	if nodes := _u.mutation.PermissionGroupBindingsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: true,
			Table:   tenant.PermissionGroupBindingsTable,
...
// SetStatus sets the "status" field.
func (_u *TenantUpdateOne) SetStatus(v int32) *TenantUpdateOne {
	_u.mutation.ResetStatus()
	_u.mutation.SetStatus(v)
	return _u
}
...
// SetNillableStatus sets the "status" field if the given value is not nil.
func (_u *TenantUpdateOne) SetNillableStatus(v *int32) *TenantUpdateOne {
	if v != nil {
		_u.SetStatus(*v)
	}
	return _u
...
// AddStatus adds value to the "status" field.
func (_u *TenantUpdateOne) AddStatus(v int32) *TenantUpdateOne {
	_u.mutation.AddStatus(v)
	return _u
}
...
// AddPermissionGroupBindingIDs adds the "permission_group_bindings" edge to the TenantPermissionGroup entity by IDs.
func (_u *TenantUpdateOne) AddPermissionGroupBindingIDs(ids ...uint32) *TenantUpdateOne {
	_u.mutation.AddPermissionGroupBindingIDs(ids...)
	return _u
}

// AddPermissionGroupBindings adds the "permission_group_bindings" edges to the TenantPermissionGroup entity.
func (_u *TenantUpdateOne) AddPermissionGroupBindings(v ...*TenantPermissionGroup) *TenantUpdateOne {
	ids := make([]uint32, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearPermissionGroupBindings clears all "permission_group_bindings" edges to the TenantPermissionGroup entity.
func (_u *TenantUpdateOne) ClearPermissionGroupBindings() *TenantUpdateOne {
	_u.mutation.ClearPermissionGroupBindings()
	return _u
}

// RemovePermissionGroupBindingIDs removes the "permission_group_bindings" edge to TenantPermissionGroup entities by IDs.
func (_u *TenantUpdateOne) RemovePermissionGroupBindingIDs(ids ...uint32) *TenantUpdateOne {
	_u.mutation.RemovePermissionGroupBindingIDs(ids...)
	return _u
}

// RemovePermissionGroupBindings removes "permission_group_bindings" edges to TenantPermissionGroup entities.
func (_u *TenantUpdateOne) RemovePermissionGroupBindings(v ...*TenantPermissionGroup) *TenantUpdateOne {
	ids := make([]uint32, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
