...
func Status(v int32) predicate.Tenant {
...
// HasPermissionGroupBindings applies the HasEdge predicate on the "permission_group_bindings" edge.
func HasPermissionGroupBindings() predicate.Tenant {
...
// HasPermissionGroupBindingsWith applies the HasEdge predicate on the "permission_group_bindings" edge with a given conditions (other predicates).
func HasPermissionGroupBindingsWith(preds ...predicate.TenantPermissionGroup) predicate.Tenant {
	return predicate.Tenant(func(s *sql.Selector) {
		step := newPermissionGroupBindingsStep()
