...
// Mutate calls f(ctx, m).
func (f DeptFunc) Mutate(ctx context.Context, m gen.Mutation) (gen.Value, error) {
	if mv, ok := m.(*gen.DeptMutation); ok {
		return f(ctx, mv)
	}
...
// Mutate calls f(ctx, m).
func (f FileObjectFunc) Mutate(ctx context.Context, m gen.Mutation) (gen.Value, error) {
	if mv, ok := m.(*gen.FileObjectMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *gen.FileObjectMutation", m)
}
...
type ProjectFunc func(context.Context, *gen.ProjectMutation) (gen.Value, error)

// Mutate calls f(ctx, m).
func (f ProjectFunc) Mutate(ctx context.Context, m gen.Mutation) (gen.Value, error) {
	if mv, ok := m.(*gen.ProjectMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *gen.ProjectMutation", m)
}
...
type StorageConfigFunc func(context.Context, *gen.StorageConfigMutation) (gen.Value, error)

// Mutate calls f(ctx, m).
func (f StorageConfigFunc) Mutate(ctx context.Context, m gen.Mutation) (gen.Value, error) {
	if mv, ok := m.(*gen.StorageConfigMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *gen.StorageConfigMutation", m)
}
