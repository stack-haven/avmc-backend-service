...
func (r *storageConfigRepo) Save(ctx context.Context, g *pbCore.StorageConfig) (*pbCore.StorageConfig, error) {
...
func (r *storageConfigRepo) Update(ctx context.Context, g *pbCore.StorageConfig) (*pbCore.StorageConfig, error) {
...
func (r *storageConfigRepo) FindByID(ctx context.Context, id uint32) (*pbCore.StorageConfig, error) {
...
func (r *storageConfigRepo) ListConfigs(ctx context.Context, opts ...listing.Option) ([]*pbCore.StorageConfig, error) {
	if _, err := r.RequireTenantID(ctx); err != nil {
		return nil, err
	}
...
func (r *storageConfigRepo) entToProto(row *gen.StorageConfig) *pbCore.StorageConfig {
	configJSON, err := r.crypt.decrypt(row.ConfigJSON)
	if err != nil {
