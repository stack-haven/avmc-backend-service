...
type StorageConfigRepo interface {
	Save(context.Context, *pbCore.StorageConfig) (*pbCore.StorageConfig, error)
	Update(context.Context, *pbCore.StorageConfig) (*pbCore.StorageConfig, error)
	FindByID(context.Context, uint32) (*pbCore.StorageConfig, error)
	CountConfigs(context.Context, ...listing.Option) (int32, error)
	ListConfigs(context.Context, ...listing.Option) ([]*pbCore.StorageConfig, error)
...
func (uc *StorageConfigUsecase) Create(ctx context.Context, g *pbCore.StorageConfig) (*pbCore.StorageConfig, error) {
	uc.log.WithContext(ctx).Infof("CreateStorageConfig: %s", g.GetName())
	return uc.repo.Save(ctx, g)
}

func (uc *StorageConfigUsecase) Update(ctx context.Context, g *pbCore.StorageConfig) (*pbCore.StorageConfig, error) {
...
func (uc *StorageConfigUsecase) Get(ctx context.Context, id uint32) (*pbCore.StorageConfig, error) {
...
func (uc *StorageConfigUsecase) ListConfigs(ctx context.Context, opts ...listing.Option) ([]*pbCore.StorageConfig, error) {
