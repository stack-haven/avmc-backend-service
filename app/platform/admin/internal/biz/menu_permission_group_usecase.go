...
func (uc *MenuPermissionGroupUsecase) PublishVersion(ctx context.Context, groupID uint32, version *pbCore.MenuPermissionGroupVersion, summary string, operatorID uint32, effectiveAt string) (*pbCore.MenuPermissionGroupVersion, error) {
