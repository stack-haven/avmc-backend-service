...
func ProtectedOperations() []Operation {
	return []Operation{
		...
		op(v1.OperationUserServiceUpdateUserByStatus, "POST"),
		...
		op(v1.OperationDeptServiceUpdateDeptByStatus, "POST"),
		...
		op(v1.OperationMenuServiceUpdateMenuByStatus, "POST"),
		...
		op(v1.OperationTenantMenuPermissionGroupServiceUpdateTenantMenuPermissionGroupStatus, "POST"),
		...
		op(v1.OperationRoleServiceUpdateRoleByStatus, "POST"),
		...
		op(v1.OperationPostServiceUpdatePostByStatus, "POST"),
		...
		op(v1.OperationProjectServiceUpdateProjectByStatus, "POST"),
