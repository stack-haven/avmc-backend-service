...
const file_common_conf_tracer_proto_rawDesc = "" +
	"\n" +
	"\x18common/conf/tracer.proto\x12\x04conf\"\x86\x01\n" +
	"\x06Tracer\x12\x18\n" +
	...
	"\binsecure\x18\x05 \x01(\bR\binsecureBm\n" +
	"\bcom.confB\vTracerProtoP\x01Z$backend-service/api/common/conf;conf\xa2\x02\x03CXX\xaa\x02\x04Conf\xca\x02\x04Conf\xe2\x02\x10Conf\\GPBMetadata\xea\x02\x04Confb\x06proto3"
