...
const file_common_conf_logger_proto_rawDesc = "" +
	"\n" +
	"\x18common/conf/logger.proto\x12\x04conf\"\xf6\x06\n" +
	"\x06Logger\x12\x12\n" +
	"\x04type\x18\x01 \x01(\tR\x04type\x12\"\n" +
	"\x03zap\x18\x02 \x01(\v2\x10.conf.Logger.ZapR\x03zap\x12+\n" +
	"\x06logrus\x18\x03 \x01(\v2\x13.conf.Logger.LogrusR\x06logrus\x12+\n" +
	"\x06fluent\x18\x04 \x01(\v2\x13.conf.Logger.FluentR\x06fluent\x12+\n" +
	"\x06aliyun\x18\x05 \x01(\v2\x13.conf.Logger.AliyunR\x06aliyun\x12.\n" +
	"\atencent\x18\x06 \x01(\v2\x14.conf.Logger.TencentR\atencent\x1a\x8c\x01\n" +
	"\x03Zap\x12\x1a\n" +
	...
	"\n" +
	"access_key\x18\x03 \x01(\tR\taccessKey\x12#\n" +
	"\raccess_secret\x18\x04 \x01(\tR\faccessSecretBm\n" +
	"\bcom.confB\vLoggerProtoP\x01Z$backend-service/api/common/conf;conf\xa2\x02\x03CXX\xaa\x02\x04Conf\xca\x02\x04Conf\xe2\x02\x10Conf\\GPBMetadata\xea\x02\x04Confb\x06proto3"
