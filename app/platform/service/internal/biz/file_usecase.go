...
type FileRepo interface {
	CreateUploadSession(context.Context, *pb.FileObject, string, time.Time) (*pb.FileObject, error)
	Get(context.Context, uint32) (*pb.FileObject, error)
	FindByIdempotencyKey(context.Context, string) (*pb.FileObject, error)
	List(context.Context, ...listing.Option) ([]*pb.FileObject, error)
	Count(context.Context, ...listing.Option) (int32, error)
	Confirm(context.Context, uint32, int64, string, string) (*pb.FileObject, error)
	Delete(context.Context, uint32) error
	UpdateFileName(context.Context, uint32, string) (*pb.FileObject, error)
	UpdateAfterReplace(context.Context, uint32, string, int64, string, string, string, string) (*pb.FileObject, error)
}

type FileAccessLogRepo interface {
	Append(context.Context, *pb.FileAccessLog) error
	List(context.Context, ...listing.Option) ([]*pb.FileAccessLog, error)
	Count(context.Context, ...listing.Option) (int32, error)
}
...
func (uc *FileUsecase) CreateUploadSession(ctx context.Context, req *pb.CreateFileUploadSessionRequest) (*pb.CreateFileUploadSessionResponse, error) {
	if req == nil {
...
func (uc *FileUsecase) UploadContent(ctx context.Context, req *pb.UploadFileContentRequest) (*pb.FileObject, error) {
...
func (uc *FileUsecase) ConfirmUpload(ctx context.Context, req *pb.ConfirmFileUploadRequest) (*pb.FileObject, error) {
	if req == nil || req.GetId() == 0 {
		return nil, errors.BadRequest("FILE_ID_REQUIRED", "文件ID不能为空")
	}
	file, err := uc.repo.Get(ctx, req.GetId())
...
func (uc *FileUsecase) Get(ctx context.Context, id uint32) (*pb.FileObject, error) {
	if id == 0 {
		return nil, errors.BadRequest("FILE_ID_REQUIRED", "文件ID不能为空")
	}
...
func (uc *FileUsecase) List(ctx context.Context, opts ...listing.Option) ([]*pb.FileObject, error) {
...
func (uc *FileUsecase) ListAccessLogs(ctx context.Context, opts ...listing.Option) ([]*pb.FileAccessLog, error) {
	if uc.accessLog == nil {
...
func (uc *FileUsecase) PresignDownload(ctx context.Context, req *pb.PresignFileDownloadRequest) (*pb.PresignFileDownloadResponse, error) {
	if req == nil || req.GetId() == 0 {
		return nil, errors.BadRequest("FILE_ID_REQUIRED", "文件ID不能为空")
	}
	file, err := uc.repo.Get(ctx, req.GetId())
	...
	if file.GetVisibility() == "public" {
		if publicURL, publicErr := provider.Client.PublicURL(file.GetBucket(), file.GetObjectKey()); publicErr == nil && publicURL != "" {
			...
			return &pb.PresignFileDownloadResponse{DownloadUrl: publicURL}, nil
		}
	}
	...
	uc.appendAccessLog(ctx, file, "download", "success", "")
	return &pb.PresignFileDownloadResponse{
		DownloadUrl: url,
...
func (uc *FileUsecase) DownloadContent(ctx context.Context, id uint32) (*pb.DownloadFileContentResponse, error) {
	if id == 0 {
		return nil, errors.BadRequest("FILE_ID_REQUIRED", "文件ID不能为空")
	}
	...
	uc.appendAccessLog(ctx, file, "download", "success", "")
	return &pb.DownloadFileContentResponse{
		Content:     content,
...
func (uc *FileUsecase) UpdateFileName(ctx context.Context, id uint32, fileName string) (*pb.FileObject, error) {
	if id == 0 {
		return nil, errors.BadRequest("FILE_ID_REQUIRED", "文件ID不能为空")
	}
...
func (uc *FileUsecase) ReplaceContent(ctx context.Context, req *pb.ReplaceFileContentRequest) (*pb.FileObject, error) {
	if req == nil || req.GetId() == 0 {
		return nil, errors.BadRequest("FILE_ID_REQUIRED", "文件ID不能为空")
	}
	if len(req.GetContent()) == 0 {
...
func (uc *FileUsecase) UploadFilePart(ctx context.Context, req *pb.UploadFilePartRequest) (*pb.UploadFilePartResponse, error) {
	if req == nil || req.GetId() == 0 {
		return nil, errors.BadRequest("FILE_ID_REQUIRED", "文件ID不能为空")
	}
	...
	return &pb.UploadFilePartResponse{Etag: etag, PartNumber: req.GetPartNumber()}, nil
}

// ListFileParts 查询已上传分片（断点续传）。本地扫描临时目录；对象存储预留为 ListParts。
func (uc *FileUsecase) ListFileParts(ctx context.Context, id uint32) (*pb.ListFilePartsResponse, error) {
	if id == 0 {
		return nil, errors.BadRequest("FILE_ID_REQUIRED", "文件ID不能为空")
	}
	file, err := uc.repo.Get(ctx, id)
	...
	pbParts := make([]*pb.FilePart, len(parts))
	for i, p := range parts {
		pbParts[i] = &pb.FilePart{PartNumber: p.PartNumber, Etag: p.ETag}
	}
	return &pb.ListFilePartsResponse{
		Parts:      pbParts,
...
func (uc *FileUsecase) CompleteFileUpload(ctx context.Context, req *pb.CompleteFileUploadRequest) (*pb.FileObject, error) {
	if req == nil || req.GetId() == 0 {
		return nil, errors.BadRequest("FILE_ID_REQUIRED", "文件ID不能为空")
	}
...
func (uc *FileUsecase) confirmWithQuota(ctx context.Context, file *pb.FileObject, size int64, sha256, etag string) (*pb.FileObject, error) {
	if file == nil {
		return nil, errors.NotFound("FILE_NOT_FOUND", "文件不存在")
	}
...
func (uc *FileUsecase) releaseFileQuota(ctx context.Context, file *pb.FileObject, idempotencyKey string) error {
...
func (uc *FileUsecase) appendAccessLog(ctx context.Context, file *pb.FileObject, action, result, message string) {
...
func (uc *FileUsecase) uploadSessionResponse(ctx context.Context, provider *ResolvedStorageProvider, file *pb.FileObject, ttl time.Duration) (*pb.CreateFileUploadSessionResponse, error) {
	if file == nil {
		return nil, errors.NotFound("FILE_NOT_FOUND", "文件不存在")
	}
	if ttl <= 0 {
	...
	if provider.Type == StorageProviderTypeLocal {
		return &pb.CreateFileUploadSessionResponse{
			File:         file,
