...
type UserRepo interface {
	Save(context.Context, *pb.User) (*pb.User, error)
	Update(context.Context, *pb.User) (*pb.User, error)
	FindByID(context.Context, uint32) (*pb.User, error)
	ListByName(context.Context, string) ([]*pb.User, error)
	ListByPhone(context.Context, string) ([]*pb.User, error)
	ListUsers(context.Context, ...listing.Option) ([]*pb.User, error)
	CountUsers(context.Context, ...listing.Option) (int32, error)
	ListUsersByDept(context.Context, uint32, bool, ...listing.Option) ([]*pb.User, error)
	CountUsersByDept(context.Context, uint32, bool, ...listing.Option) (int32, error)
	ListAll(context.Context) ([]*pb.User, error)
	ListPageSimple(context.Context, ...listing.Option) ([]*pb.User, error)
...
func (uc *UserUsecase) Create(ctx context.Context, g *pb.User) (*pb.User, error) {
...
// Get 获取用户
func (uc *UserUsecase) Get(ctx context.Context, id uint32) (*pb.User, error) {
	uc.log.WithContext(ctx).Infof("GetUser: %v", id)
	return uc.repo.FindByID(ctx, id)
}

// Update 更新用户 — 业务逻辑：密码变更时重哈希
func (uc *UserUsecase) Update(ctx context.Context, g *pb.User) (*pb.User, error) {
...
func (uc *UserUsecase) ListPageSimple(ctx context.Context, opts ...listing.Option) ([]*pb.User, error) {
...
// UpdateStatus 更新用户状态
func (uc *UserUsecase) UpdateStatus(ctx context.Context, id uint32, status int32) (*pb.User, error) {
...
// ListUsers 用户列表
func (uc *UserUsecase) ListUsers(ctx context.Context, opts ...listing.Option) ([]*pb.User, error) {
...
func (uc *UserUsecase) ListUsersByDept(ctx context.Context, deptID uint32, includeChildren bool, opts ...listing.Option) ([]*pb.User, error) {
