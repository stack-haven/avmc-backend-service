...
type RoleRepo interface {
	Save(context.Context, *pb.Role) (*pb.Role, error)
	Update(context.Context, *pb.Role) (*pb.Role, error)
	FindByID(context.Context, uint32) (*pb.Role, error)
	CountRoles(context.Context, ...listing.Option) (int32, error)
	ListAll(context.Context) ([]*pb.Role, error)
	ListRoles(context.Context, ...listing.Option) ([]*pb.Role, error)
...
// Create 创建角色
func (uc *RoleUsecase) Create(ctx context.Context, g *pb.Role) (*pb.Role, error) {
	uc.log.WithContext(ctx).Infof("CreateRole: %v", g.GetName())
	return uc.repo.Save(ctx, g)
}

// Get 获取角色
func (uc *RoleUsecase) Get(ctx context.Context, id uint32) (*pb.Role, error) {
	return uc.repo.FindByID(ctx, id)
}

// Update 更新角色 — 先验证存在再更新
func (uc *RoleUsecase) Update(ctx context.Context, g *pb.Role) (*pb.Role, error) {
...
// ListSimple 角色简单列表
func (uc *RoleUsecase) ListSimple(ctx context.Context) ([]*pb.Role, error) {
	return uc.repo.ListAll(ctx)
}

// ListRoles 角色分页列表
func (uc *RoleUsecase) ListRoles(ctx context.Context, opts ...listing.Option) ([]*pb.Role, error) {
...
// UpdateStatus 更新角色状态
func (uc *RoleUsecase) UpdateStatus(ctx context.Context, id uint32, status int32) (*pb.Role, error) {
