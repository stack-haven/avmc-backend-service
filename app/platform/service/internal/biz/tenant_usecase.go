...
type TenantRepo interface {
	...
	Update(context.Context, *pb.Tenant, uint32) (*pb.Tenant, error)
	FindByID(context.Context, uint32) (*pb.Tenant, error)
	CountTenants(context.Context, ...listing.Option) (int32, error)
	ListTenants(context.Context, ...listing.Option) ([]*pb.Tenant, error)
	Delete(context.Context, uint32) error
	UpdateLifecycle(context.Context, uint32, pb.TenantLifecycleStatus) (*pb.Tenant, error)
	ListAdmins(context.Context, uint32) ([]*pb.User, error)
	UpdateAdmin(context.Context, uint32, uint32, *string, *string, *string) (*pb.User, error)
	ResetAdminPassword(context.Context, uint32, uint32, string) error
}

func (uc *TenantUsecase) ListAdmins(ctx context.Context, tenantID uint32) ([]*pb.User, error) {
...
func (uc *TenantUsecase) UpdateAdmin(ctx context.Context, req *pb.UpdateTenantAdminRequest) (*pb.User, error) {
	if req.GetEmail() != "" {
...
func (uc *TenantUsecase) ResetAdminPassword(ctx context.Context, req *pb.ResetTenantAdminPasswordRequest) error {
...
func (uc *TenantUsecase) Create(ctx context.Context, tenant *pb.Tenant, admin *pb.TenantInitialAdmin, operatorID uint32) (*TenantProvisioningResult, error) {
...
func (uc *TenantUsecase) Update(ctx context.Context, tenant *pb.Tenant, operatorID uint32) (*pb.Tenant, error) {
...
func (uc *TenantUsecase) Get(ctx context.Context, id uint32) (*pb.Tenant, error) {
...
func (uc *TenantUsecase) List(ctx context.Context, opts ...listing.Option) ([]*pb.Tenant, error) {
...
func (uc *TenantUsecase) UpdateLifecycle(ctx context.Context, id uint32, target pb.TenantLifecycleStatus) (*pb.Tenant, error) {
	...
	if current.GetLifecycleStatus() == pb.TenantLifecycleStatus_TENANT_LIFECYCLE_STATUS_ACTIVE &&
		target != pb.TenantLifecycleStatus_TENANT_LIFECYCLE_STATUS_ACTIVE &&
		uc.sessions != nil {
...
func tenantLifecycleTransitionAllowed(current, target pb.TenantLifecycleStatus) bool {
	if current == target {
		return true
	}
	switch current {
	case pb.TenantLifecycleStatus_TENANT_LIFECYCLE_STATUS_PENDING:
		return target == pb.TenantLifecycleStatus_TENANT_LIFECYCLE_STATUS_ACTIVE ||
			target == pb.TenantLifecycleStatus_TENANT_LIFECYCLE_STATUS_CANCELLED
	case pb.TenantLifecycleStatus_TENANT_LIFECYCLE_STATUS_ACTIVE:
		return target == pb.TenantLifecycleStatus_TENANT_LIFECYCLE_STATUS_SUSPENDED ||
			target == pb.TenantLifecycleStatus_TENANT_LIFECYCLE_STATUS_EXPIRED ||
			target == pb.TenantLifecycleStatus_TENANT_LIFECYCLE_STATUS_CANCELLED
	case pb.TenantLifecycleStatus_TENANT_LIFECYCLE_STATUS_SUSPENDED:
		return target == pb.TenantLifecycleStatus_TENANT_LIFECYCLE_STATUS_ACTIVE ||
			target == pb.TenantLifecycleStatus_TENANT_LIFECYCLE_STATUS_EXPIRED ||
			target == pb.TenantLifecycleStatus_TENANT_LIFECYCLE_STATUS_CANCELLED
	case pb.TenantLifecycleStatus_TENANT_LIFECYCLE_STATUS_EXPIRED:
		return target == pb.TenantLifecycleStatus_TENANT_LIFECYCLE_STATUS_ACTIVE ||
			target == pb.TenantLifecycleStatus_TENANT_LIFECYCLE_STATUS_CANCELLED
	default:
		return false
