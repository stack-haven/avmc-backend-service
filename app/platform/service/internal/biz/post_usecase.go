...
type PostRepo interface {
	Save(context.Context, *pb.Post) (*pb.Post, error)
	Update(context.Context, *pb.Post) (*pb.Post, error)
	FindByID(context.Context, uint32) (*pb.Post, error)
	CountPosts(context.Context, ...listing.Option) (int32, error)
	ListAll(context.Context) ([]*pb.Post, error)
	ListPosts(context.Context, ...listing.Option) ([]*pb.Post, error) // 新增的方法用于分页查询
...
// 参数：ctx 上下文，g 岗位信息
// 返回值：创建后的岗位信息，错误信息
func (uc *PostUsecase) Create(ctx context.Context, g *pb.Post) (*pb.Post, error) {
...
// 参数：ctx 上下文，id 岗位ID
// 返回值：岗位详情，错误信息
func (uc *PostUsecase) Get(ctx context.Context, id uint32) (*pb.Post, error) {
...
// 参数：ctx 上下文，g 岗位信息
// 返回值：更新后的岗位信息，错误信息
func (uc *PostUsecase) Update(ctx context.Context, g *pb.Post) (*pb.Post, error) {
...
// 返回值：岗位列表，错误信息
func (uc *PostUsecase) ListSimple(ctx context.Context, pageNum, pageSize int64) ([]*pb.Post, error) {
...
// 返回值：岗位列表响应，错误信息
func (uc *PostUsecase) ListPosts(ctx context.Context, opts ...listing.Option) ([]*pb.Post, error) {
