...
const file_common_conf_oss_proto_rawDesc = "" +
	"\n" +
	"\x15common/conf/oss.proto\x12\x04conf\"\x85\x02\n" +
	"\x03OSS\x12%\n" +
	"\x05minio\x18\x01 \x01(\v2\x0f.conf.OSS.MinIOR\x05minio\x1a\xd6\x01\n" +
	"\x05MinIO\x12\x1a\n" +
	...
	"uploadHost\x12#\n" +
	"\rdownload_host\x18\a \x01(\tR\fdownloadHostBj\n" +
	"\bcom.confB\bOssProtoP\x01Z$backend-service/api/common/conf;conf\xa2\x02\x03CXX\xaa\x02\x04Conf\xca\x02\x04Conf\xe2\x02\x10Conf\\GPBMetadata\xea\x02\x04Confb\x06proto3"
