...
const file_common_conf_config_proto_rawDesc = "" +
	"\n" +
	"\x18common/conf/config.proto\x12\x04conf\x1a\x1egoogle/protobuf/duration.proto\"\xa3\x06\n" +
	...
	"kubernetes\x124\n" +
	"\apolaris\x18\b \x01(\v2\x1a.conf.RemoteConfig.PolarisR\apolaris\x1aG\n" +
	"\x05Nacos\x12\x18\n" +
	...
	"\aPolarisBm\n" +
	"\bcom.confB\vConfigProtoP\x01Z$backend-service/api/common/conf;conf\xa2\x02\x03CXX\xaa\x02\x04Conf\xca\x02\x04Conf\xe2\x02\x10Conf\\GPBMetadata\xea\x02\x04Confb\x06proto3"
