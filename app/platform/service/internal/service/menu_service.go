...
// 参数：ctx 上下文，req 分页请求
// 返回值：菜单列表响应，错误信息
func (s *MenuServiceService) ListMenus(ctx context.Context, req *pb.ListMenusRequest) (*pb.ListMenusResponse, error) {
...
// 参数：ctx 上下文，req 分页请求
// 返回值：菜单树形列表响应，错误信息
func (s *MenuServiceService) ListMenusTree(ctx context.Context, req *pb.ListMenusTreeRequest) (*pb.ListMenusTreeResponse, error) {
...
// 返回值：菜单详情，错误信息
func (s *MenuServiceService) GetMenu(ctx context.Context, req *pb.GetMenuRequest) (*pb.Menu, error) {
	if req.GetId() == 0 {
...
// 返回值：创建菜单响应，错误信息
func (s *MenuServiceService) CreateMenu(ctx context.Context, req *pb.CreateMenuRequest) (*pb.CreateMenuResponse, error) {
	if req.GetMenu() == nil {
...
// 返回值：更新菜单响应，错误信息
func (s *MenuServiceService) UpdateMenu(ctx context.Context, req *pb.UpdateMenuRequest) (*pb.UpdateMenuResponse, error) {
	if req.GetId() == 0 {
		return nil, pb.ErrorMenuInvalidId("菜单ID不能为空")
	}
	if req.GetMenu() == nil {
	...
	existing, err := s.GetMenu(ctx, &pb.GetMenuRequest{Id: req.GetId()})
	if err != nil {
		return nil, err
	}
...
// 返回值：删除菜单响应，错误信息
func (s *MenuServiceService) DeleteMenu(ctx context.Context, req *pb.DeleteMenuRequest) (*pb.DeleteMenuResponse, error) {
	if req.GetId() == 0 {
		return nil, pb.ErrorMenuInvalidId("菜单ID不能为空")
	}
...
func (s *MenuServiceService) ExistMenuByPath(ctx context.Context, req *pb.ExistMenuByPathRequest) (*pb.ExistMenuByPathResponse, error) {
	if req.GetPath() == "" {
		return &pb.ExistMenuByPathResponse{
			Exist: false,
		}, nil
	}
...
func (s *MenuServiceService) ExistMenuByName(ctx context.Context, req *pb.ExistMenuByNameRequest) (*pb.ExistMenuByNameResponse, error) {
	if req.GetName() == "" {
		return &pb.ExistMenuByNameResponse{
			Exist: false,
		}, nil
	}
