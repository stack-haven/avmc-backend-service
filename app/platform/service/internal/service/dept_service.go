...
// 参数：ctx 上下文，req 分页请求
// 返回值：部门列表响应，错误信息
func (s *DeptServiceService) ListDepts(ctx context.Context, req *pb.ListDeptsRequest) (*pb.ListDeptsResponse, error) {
...
// 返回值：部门详情，错误信息
func (s *DeptServiceService) GetDept(ctx context.Context, req *pb.GetDeptRequest) (*pb.Dept, error) {
...
// 返回值：创建部门响应，错误信息
func (s *DeptServiceService) CreateDept(ctx context.Context, req *pb.CreateDeptRequest) (*pb.CreateDeptResponse, error) {
	s.log.Infof("创建部门，部门名称：%s", req.GetDept().GetName())
	_, err := s.duc.Create(ctx, req.Dept)
	if err != nil {
		return nil, err
	}
	return &pb.CreateDeptResponse{}, nil
}

// UpdateDept 处理更新部门请求
// 参数：ctx 上下文，req 更新部门请求
// 返回值：更新部门响应，错误信息
func (s *DeptServiceService) UpdateDept(ctx context.Context, req *pb.UpdateDeptRequest) (*pb.UpdateDeptResponse, error) {
	existing, err := s.GetDept(ctx, &pb.GetDeptRequest{Id: req.GetId()})
	if err != nil {
		return nil, err
	}
	...
	return &pb.UpdateDeptResponse{}, nil
}

// DeleteDept 处理删除部门请求
// 参数：ctx 上下文，req 删除部门请求
// 返回值：删除部门响应，错误信息
func (s *DeptServiceService) DeleteDept(ctx context.Context, req *pb.DeleteDeptRequest) (*pb.DeleteDeptResponse, error) {
...
func (s *DeptServiceService) GetDeptDeleteImpact(ctx context.Context, req *pb.GetDeptDeleteImpactRequest) (*pb.GetDeptDeleteImpactResponse, error) {
	return s.duc.GetDeleteImpact(ctx, req.GetId())
}

func (s *DeptServiceService) TransferAndDeleteDept(ctx context.Context, req *pb.TransferAndDeleteDeptRequest) (*pb.TransferAndDeleteDeptResponse, error) {
	count, err := s.duc.TransferAndDelete(ctx, req.GetId(), req.GetTargetDeptId())
	if err != nil {
		return nil, err
	}
	return &pb.TransferAndDeleteDeptResponse{TransferredUserCount: count}, nil
}

// ListDeptTree 处理部门树形列表请求
// 参数：ctx 上下文，req 分页请求
// 返回值：部门树形列表响应，错误信息
func (s *DeptServiceService) ListDeptsTree(ctx context.Context, req *pb.ListDeptsTreeRequest) (*pb.ListDeptsTreeResponse, error) {
