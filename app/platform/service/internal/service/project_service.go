...
func (s *ProjectServiceService) ListProjects(ctx context.Context, req *pb.ListProjectsRequest) (*pb.ListProjectsResponse, error) {
...
func (s *ProjectServiceService) GetProject(ctx context.Context, req *pb.GetProjectRequest) (*pb.Project, error) {
	s.log.Infof("获取项目详情，项目ID：%v", req.GetId())
	return s.puc.Get(ctx, req.GetId())
}

// CreateProject handles create project requests.
func (s *ProjectServiceService) CreateProject(ctx context.Context, req *pb.CreateProjectRequest) (*pb.CreateProjectResponse, error) {
...
func (s *ProjectServiceService) UpdateProject(ctx context.Context, req *pb.UpdateProjectRequest) (*pb.UpdateProjectResponse, error) {
...
func (s *ProjectServiceService) DeleteProject(ctx context.Context, req *pb.DeleteProjectRequest) (*pb.DeleteProjectResponse, error) {
...
func (s *ProjectServiceService) UpdateProjectByStatus(ctx context.Context, req *pb.UpdateProjectByStatusRequest) (*pb.UpdateProjectByStatusResponse, error) {
	s.log.Infof("更新项目状态，项目ID：%v，状态：%v", req.GetId(), req.GetStatus())
	err := s.puc.UpdateStatus(ctx, req.GetId(), req.GetStatus())
	if err != nil {
		return nil, err
	}
	return &pb.UpdateProjectByStatusResponse{}, nil
}
