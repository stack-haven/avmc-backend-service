...
// 参数：ctx 上下文，req 分页请求
// 返回值：岗位列表响应，错误信息
func (s *PostServiceService) ListPosts(ctx context.Context, req *pb.ListPostsRequest) (*pb.ListPostsResponse, error) {
...
// 返回值：创建岗位响应，错误信息
func (s *PostServiceService) CreatePost(ctx context.Context, req *pb.CreatePostRequest) (*pb.CreatePostResponse, error) {
...
// 返回值：更新岗位响应，错误信息
func (s *PostServiceService) UpdatePost(ctx context.Context, req *pb.UpdatePostRequest) (*pb.UpdatePostResponse, error) {
...
// 返回值：删除岗位响应，错误信息
func (s *PostServiceService) DeletePost(ctx context.Context, req *pb.DeletePostRequest) (*pb.DeletePostResponse, error) {
