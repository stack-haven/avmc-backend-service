...
func notificationProviderProto(row *gen.NotificationProvider, includeSecret bool) *pb.NotificationProvider {
	if row == nil {
		return nil
	}
	status := row.Status
...
func (r *notificationProviderRepo) Create(ctx context.Context, item *pb.NotificationProvider) (*pb.NotificationProvider, error) {
	systemCtx := entviewer.NewSystemContext(ctx)
	var result *pb.NotificationProvider
...
func (r *notificationProviderRepo) Update(ctx context.Context, item *pb.NotificationProvider) (*pb.NotificationProvider, error) {
	systemCtx := entviewer.NewSystemContext(ctx)
	var result *pb.NotificationProvider
	err := r.Data.InTx(systemCtx, func(txCtx context.Context) error {
...
func (r *notificationProviderRepo) Get(ctx context.Context, id uint32) (*pb.NotificationProvider, error) {
...
func (r *notificationProviderRepo) List(ctx context.Context, req *pb.ListNotificationProvidersRequest) ([]*pb.NotificationProvider, int32, error) {
	systemCtx := entviewer.NewSystemContext(ctx)
	...
	return convert.SliceToAny(rows, func(row *gen.NotificationProvider) *pb.NotificationProvider {
		return notificationProviderProto(row, false)
	}), int32(total), nil
}

func (r *notificationProviderRepo) SetDefault(ctx context.Context, id uint32) (*pb.NotificationProvider, error) {
	systemCtx := entviewer.NewSystemContext(ctx)
	var result *pb.NotificationProvider
	err := r.Data.InTx(systemCtx, func(txCtx context.Context) error {
...
func (r *notificationProviderRepo) ResolveChannel(ctx context.Context, channel string) (*pb.NotificationProvider, json.RawMessage, error) {
	systemCtx := entviewer.NewSystemContext(ctx)
...
func notificationProviderObjectConfig(item *pb.NotificationProvider) (json.RawMessage, error) {
