...
func (r *menuRepo) convertProto(res *gen.Menu) *pb.Menu {
	...
	return &pb.Menu{
		...
		Meta: &pb.MenuMeta{
			...
			Badge:              res.Badge,
			BadgeType:          (*pb.BadgeType)(res.BadgeType),
			BadgeVariants:      (*pb.BadgeVariants)(res.BadgeVariants),
...
func (r *menuRepo) convertEnt(g *pb.Menu) *gen.Menu {
	meta := g.GetMeta()
	if meta == nil {
		meta = &pb.MenuMeta{}
	}
...
func (r *menuRepo) Save(ctx context.Context, g *pb.Menu) (*pb.Menu, error) {
	if g == nil || g.GetName() == "" {
	...
	exist, err := r.ExistByName(ctx, &pb.ExistMenuByNameRequest{
		Name: g.Name,
		Id:   &g.Id,
	})
	if err != nil {
	...
	if g.GetPath() != "" {
		exist, err = r.ExistByPath(ctx, &pb.ExistMenuByPathRequest{Path: g.GetPath(), Id: &g.Id})
		if err != nil {
...
func (r *menuRepo) Update(ctx context.Context, g *pb.Menu) (*pb.Menu, error) {
...
func (r *menuRepo) FindByID(ctx context.Context, id uint32) (*pb.Menu, error) {
...
func (r *menuRepo) ListByName(ctx context.Context, name string) ([]*pb.Menu, error) {
...
func (r *menuRepo) ListAllSimple(ctx context.Context) ([]*pb.Menu, error) {
...
func (r *menuRepo) ListAll(ctx context.Context) ([]*pb.Menu, error) {
...
func (r *menuRepo) ListMenus(ctx context.Context, opts ...listing.Option) ([]*pb.Menu, error) {
...
func (r *menuRepo) ExistByPath(ctx context.Context, req *pb.ExistMenuByPathRequest) (bool, error) {
...
func (r *menuRepo) ExistByName(ctx context.Context, req *pb.ExistMenuByNameRequest) (bool, error) {
	builder := r.Data.DB(ctx).Menu.Query()
	if req.GetId() != 0 {
