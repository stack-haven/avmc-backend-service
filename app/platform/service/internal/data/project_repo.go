...
func (r *projectRepo) convertProto(res *gen.Project, ownerNames map[uint32]*string) *pb.Project {
...
func (r *projectRepo) Save(ctx context.Context, g *pb.Project) (*pb.Project, error) {
	if g == nil || g.GetName() == "" {
...
func (r *projectRepo) Update(ctx context.Context, g *pb.Project) (*pb.Project, error) {
...
func (r *projectRepo) FindByID(ctx context.Context, id uint32) (*pb.Project, error) {
	if _, err := r.RequireTenantID(ctx); err != nil {
		return nil, err
	}
...
func (r *projectRepo) ListProjects(ctx context.Context, opts ...listing.Option) ([]*pb.Project, error) {
	if _, err := r.RequireTenantID(ctx); err != nil {
		return nil, err
	}
	...
	return convert.SliceToAny(res, func(item *gen.Project) *pb.Project {
