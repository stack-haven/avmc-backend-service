...
func deviceToProto(row *gen.Device) *pb.Device {
	if row == nil {
		return nil
	}
	return &pb.Device{
...
func (r *deviceRepo) Upsert(ctx context.Context, item *pb.Device) (*pb.Device, error) {
...
func (r *deviceRepo) ListByUser(ctx context.Context, userID uint32) ([]*pb.Device, error) {
	if _, err := r.RequireTenantID(ctx); err != nil {
		return nil, err
	}
