...
// entToProto 将 ent.Role 转换为 pb.Role
func (r *roleRepo) entToProto(e *gen.Role) *pb.Role {
	if e == nil {
		return nil
	}
...
// protoToEnt 将 pb.Role 转换为 ent.Role
func (r *roleRepo) protoToEnt(g *pb.Role) *gen.Role {
	return &gen.Role{
		ID:                g.GetId(),
		Name:              g.Name,
...
// Save 保存角色
func (r *roleRepo) Save(ctx context.Context, g *pb.Role) (*pb.Role, error) {
	if g == nil || g.GetName() == "" {
...
// Update 更新角色
func (r *roleRepo) Update(ctx context.Context, g *pb.Role) (*pb.Role, error) {
...
// FindByID 根据 ID 查询
func (r *roleRepo) FindByID(ctx context.Context, id uint32) (*pb.Role, error) {
...
// ListAll 查询所有角色
func (r *roleRepo) ListAll(ctx context.Context) ([]*pb.Role, error) {
	if _, err := r.RequireTenantID(ctx); err != nil {
		return nil, err
	}
	res, err := r.Data.DB(ctx).Role.Query().
...
// ListRoles 分页查询角色
func (r *roleRepo) ListRoles(ctx context.Context, opts ...listing.Option) ([]*pb.Role, error) {
	if _, err := r.RequireTenantID(ctx); err != nil {
		return nil, err
	}
