...
const (
	// Label holds the string label denoting the tenantmenupermissiongroup type in the database.
	Label = "tenant_menu_permission_group"
	...
	EdgeTenants = "tenants"
	// Table holds the table name of the tenantmenupermissiongroup in the database.
	...
	MenusTable = "system_tenant_menu_permission_group_menus"
	...
	CurrentVersionTable = "system_tenant_menu_permission_groups"
	// CurrentVersionInverseTable is the table name for the TenantMenuPermissionGroupVersion entity.
	// It exists in this package in order to avoid circular dependency with the "tenantmenupermissiongroupversion" package.
	CurrentVersionInverseTable = "system_tenant_menu_permission_group_versions"
	...
	VersionsTable = "system_tenant_menu_permission_group_versions"
	// VersionsInverseTable is the table name for the TenantMenuPermissionGroupVersion entity.
	// It exists in this package in order to avoid circular dependency with the "tenantmenupermissiongroupversion" package.
	VersionsInverseTable = "system_tenant_menu_permission_group_versions"
	...
	TenantsTable = "system_tenant_groups"
	// TenantsInverseTable is the table name for the Tenant entity.
	// It exists in this package in order to avoid circular dependency with the "tenant" package.
	TenantsInverseTable = "system_tenants"
)

// Columns holds all SQL columns for tenantmenupermissiongroup fields.
var Columns = []string{
	FieldID,
	FieldStatus,
	FieldCreatedAt,
...
var (
	...
	MenusPrimaryKey = []string{"tenant_menu_permission_group_id", "menu_id"}
	// TenantsPrimaryKey and TenantsColumn2 are the table columns denoting the
	// primary key for the tenants relation (M2M).
	TenantsPrimaryKey = []string{"tenant_id", "tenant_menu_permission_group_id"}
)
...
// OrderOption defines the ordering options for the TenantMenuPermissionGroup queries.
