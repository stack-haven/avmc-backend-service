...
type TenantEdges struct {
	// 绑定的租户套餐
	Groups []*TenantMenuPermissionGroup `json:"groups,omitempty"`
...
func (e TenantEdges) GroupsOrErr() ([]*TenantMenuPermissionGroup, error) {
	if e.loadedTypes[0] {
		return e.Groups, nil
	}
...
func (*Tenant) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case tenant.FieldID, tenant.FieldSort, tenant.FieldLifecycleStatus:
...
func (_m *Tenant) QueryGroups() *TenantMenuPermissionGroupQuery {
