...
func (_q *DeviceQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *DeviceQuery) FirstIDX(ctx context.Context) uint32 {
...
func (_q *DeviceQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *DeviceQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (_q *DeviceQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (_q *DeviceQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *DeviceQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(device.Table, device.Columns, sqlgraph.NewFieldSpec(device.FieldID, field.TypeUint32))
	_spec.From = _q.sql
