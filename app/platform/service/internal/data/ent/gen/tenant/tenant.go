...
const (
	...
	GroupsTable = "system_tenant_groups"
	// GroupsInverseTable is the table name for the TenantMenuPermissionGroup entity.
	// It exists in this package in order to avoid circular dependency with the "tenantmenupermissiongroup" package.
	GroupsInverseTable = "system_tenant_menu_permission_groups"
)
...
var (
	...
	GroupsPrimaryKey = []string{"tenant_id", "tenant_menu_permission_group_id"}
)
