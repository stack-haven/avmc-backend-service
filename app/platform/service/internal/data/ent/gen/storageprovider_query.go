...
func (_q *StorageProviderQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *StorageProviderQuery) FirstIDX(ctx context.Context) uint32 {
...
func (_q *StorageProviderQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *StorageProviderQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (_q *StorageProviderQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (_q *StorageProviderQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(storageprovider.FieldStatus).
//		Aggregate(gen.Count()).
//		Scan(ctx, &v)
...
//
//	client.StorageProvider.Query().
//		Select(storageprovider.FieldStatus).
//		Scan(ctx, &v)
...
func (_q *StorageProviderQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(storageprovider.Table, storageprovider.Columns, sqlgraph.NewFieldSpec(storageprovider.FieldID, field.TypeUint32))
	_spec.From = _q.sql
...
func (_q *StorageProviderQuery) ForUpdate(opts ...sql.LockOption) *StorageProviderQuery {
...
func (_q *StorageProviderQuery) ForShare(opts ...sql.LockOption) *StorageProviderQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
...
func (_q *StorageProviderQuery) Modify(modifiers ...func(s *sql.Selector)) *StorageProviderSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (_s *StorageProviderSelect) Modify(modifiers ...func(s *sql.Selector)) *StorageProviderSelect {
