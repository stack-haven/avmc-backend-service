...
func storageProviderProto(row *gen.StorageProvider, includeSecret bool) *pb.StorageProvider {
	if row == nil {
		return nil
	}
	status := row.Status
...
func (r *storageProviderRepo) Create(ctx context.Context, item *pb.StorageProvider) (*pb.StorageProvider, error) {
	if item == nil {
		return nil, pb.ErrorBadRequest("存储渠道不能为空")
	}
	systemCtx := entviewer.NewSystemContext(ctx)
	var result *pb.StorageProvider
...
func (r *storageProviderRepo) Update(ctx context.Context, item *pb.StorageProvider) (*pb.StorageProvider, error) {
	systemCtx := entviewer.NewSystemContext(ctx)
	var result *pb.StorageProvider
	err := r.Data.InTx(systemCtx, func(txCtx context.Context) error {
...
func (r *storageProviderRepo) Get(ctx context.Context, id uint32) (*pb.StorageProvider, error) {
...
func (r *storageProviderRepo) List(ctx context.Context, req *pb.ListStorageProvidersRequest) ([]*pb.StorageProvider, int32, error) {
	systemCtx := entviewer.NewSystemContext(ctx)
	...
	return convert.SliceToAny(rows, func(row *gen.StorageProvider) *pb.StorageProvider {
		return storageProviderProto(row, false)
	}), int32(total), nil
}

func (r *storageProviderRepo) SetDefault(ctx context.Context, id uint32) (*pb.StorageProvider, error) {
	systemCtx := entviewer.NewSystemContext(ctx)
	var result *pb.StorageProvider
	err := r.Data.InTx(systemCtx, func(txCtx context.Context) error {
...
func (r *storageProviderRepo) BuildClient(_ context.Context, item *pb.StorageProvider) (objectstorage.Client, error) {
...
func storageProviderObjectConfig(item *pb.StorageProvider) (json.RawMessage, error) {
