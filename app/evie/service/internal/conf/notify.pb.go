...
const file_common_conf_notify_proto_rawDesc = "" +
	"\n" +
	"\x18common/conf/notify.proto\x12\x04conf\"\xc9\x01\n" +
	"\fNotification\x12(\n" +
	"\x03sms\x18\x01 \x01(\v2\x16.conf.Notification.SMSR\x03sms\x1a\x8e\x01\n" +
	"\x03SMS\x12\x1a\n" +
	...
	"\x11access_key_secret\x18\x04 \x01(\tR\x0faccessKeySecretBm\n" +
	"\bcom.confB\vNotifyProtoP\x01Z$backend-service/api/common/conf;conf\xa2\x02\x03CXX\xaa\x02\x04Conf\xca\x02\x04Conf\xe2\x02\x10Conf\\GPBMetadata\xea\x02\x04Confb\x06proto3"
