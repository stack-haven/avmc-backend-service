...
func wireApp(confServer *conf.Server, client *conf.Client, confData *conf.Data, oss *conf.OSS, logger log.Logger) (*kratos.App, func(), error) {
	...
	asrServiceService := service.NewASRServiceService(asrUsecase, enhancementEngine, enhancementPolicyUsecase, enhancementLogUsecase, logger)
	...
	enhancementServiceService := service.NewEnhancementServiceService(enhancementEngine, enhancementPolicyUsecase, enhancementLogUsecase, logger)
	...
	httpServer, err := server.NewHTTPServer(confServer, logger, manager, enforcer, checker, dictionaryServiceService, asrServiceService, asrStreamService, providerServiceService, enhancementServiceService, auditClient)
	if err != nil {
		cleanup()
		return nil, nil, err
	}
