...
func wireApp(confServer *conf.Server, confData *conf.Data, logger log.Logger) (*kratos.App, func(), error) {
	...
	authorized := data.NewAuthorizer(confData, logger)
	...
	httpServer := server.NewHTTPServer(confServer, logger, authenticator, authorized, userToken, authServiceService, userServiceService, deptServiceService, menuServiceService, roleServiceService, postServiceService)
