...
type MenuRepo interface {
	...
	FindByID(context.Context, int64) (*pbCore.Menu, error)
...
func (uc *MenuUsecase) CreateMenu(ctx context.Context, g *pbCore.Menu) (*pbCore.Menu, error) {
...
func (uc *MenuUsecase) Get(ctx context.Context, id int64) (*pbCore.Menu, error) {
...
func (uc *MenuUsecase) List(ctx context.Context, pageNum, pageSize int64) ([]*pbCore.Menu, error) {
