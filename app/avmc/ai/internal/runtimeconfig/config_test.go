...
func TestValidateRejectsUnsafeProductionDefaults(t *testing.T) {
	...
	if !strings.Contains(err.Error(), "AVMC_AI_JWT_KEY") {
...
func TestApplyEnvOverrides(t *testing.T) {
	...
	t.Setenv("AVMC_AI_GRPC_ADDR", "127.0.0.1:19001")
	t.Setenv("AVMC_AI_JWT_KEY", "test-secret")
	t.Setenv("AVMC_AI_CORS_ORIGINS", "https://ai.example.com, https://ops.example.com")
	t.Setenv("AVMC_AI_DB_SOURCE", "user:pass@tcp(db:3306)/ai")
	t.Setenv("AVMC_AI_DB_DEBUG", "false")
	t.Setenv("AVMC_AI_REDIS_PASSWORD", "")
	...
	return &conf.Bootstrap{
		...
		Data: &conf.Data{
			Database: &conf.Data_Database{
				Driver:  "mysql",
				Source:  "root:123456@tcp(127.0.0.1:3306)/avmc_ai",
				Debug:   true,
				Migrate: true,
			},
